...
function mh_trip_script( $atts ) {
    ...
    $objectinsertt  = "<script src='".$serviceUri."/p/".$partnerr."/sp/".$partnerr."00/embedIframeJs/uiconf_id/".KALTURA_PLAYER_UI_CONFIG."/partner_id/".$partnerr."'></script>
...
kWidget.thumbEmbed({
  ...
  'wid': '_".$partnerr."',
  'uiconf_id': '".KALTURA_PLAYER_UI_CONFIG."',
  'flashvars': {
    'streamerType': 'auto'
  },
  'cache_st': '1437197987',
