...
function kaltst_lst() {
    ...
    $serviceUri = KALTURA_SERVICE_URL;
    $partnerr   = KALTURA_PARTNER_ID;
...
<script>
    var KALTURA_SERVICE_URL = '<?php echo KALTURA_SERVICE_URL ?>';
    var KALTURA_PARTNER_ID  = '<?php echo KALTURA_PARTNER_ID ?>';
    var KALTURA_PARTNER_UI_CONFIG  = '<?php echo KALTURA_PLAYER_UI_CONFIG ?>';
</script>
<div class="container">
    <div class="row">
<form action="" method="post" id='myForm' role="form">
            ...
            <?php foreach ($objEntry as $mediaEntry) : ?>
                <tr>
                        ...
                        <td><?php echo "<img  width='300px' height='140px' src='".KALTURA_SERVICE_URL."/p/".KALTURA_PARTNER_ID."/thumbnail/entry_id/".$mediaEntry->id."/width/300/height/140/type/1/quality/100' onmouseover='KalturaThumbRotator.start(this)' onmouseout='KalturaThumbRotator.end(this)'/>"; ?></td>
                <td style="vertical-align:middle;  padding: 2%;">
                        <input type="radio" id="someval" class="someval" name="someval" value="<?php echo $mediaEntry->id ;?>">
                </td>
                </tr>
            <?php endforeach; ?>
                    </tbody>
...
<script> someFunction();</script>
  ...
  <div class="modal-dialog" style="top:5%;">
    <div class="modal-content">
      ...
      <div class="modal-body" id="modd" style='width: 100%;display: inline-block;position: relative;'>
          <div style='width: 100%;display: inline-block;position: relative;'>
              <div id='dummy' style='margin-top: 56.25%;'>
                  <?php echo "<script src='".KALTURA_SERVICE_URL."p/".KALTURA_PARTNER_ID."/sp/".KALTURA_PARTNER_ID."00/embedIframeJs/uiconf_id/".KALTURA_PLAYER_UI_CONFIG."/partner_id/".KALTURA_PARTNER_ID."'></script>"; ?>
      ...
      <div class="modal-footer">
        <button onclick="stopVideo()" type="button" class="btn btn-default" id="closing" data-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
</div>
