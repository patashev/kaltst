...
KalturaCuePointStatus.READY=1;KalturaCuePointStatus.DELETED=2;KalturaCuePointStatus.HANDLED=3;KalturaCuePointStatus.PENDING=4;function KalturaDVRStatus(){}
...
KalturaGenericDistributionProviderStatus.ACTIVE=2;KalturaGenericDistributionProviderStatus.DELETED=3;function KalturaGroupUserStatus(){}
KalturaGroupUserStatus.ACTIVE=0;KalturaGroupUserStatus.DELETED=1;function KalturaHttpNotificationAuthenticationMethod(){}
...
KalturaScheduledTaskProfileStatus.DISABLED=1;KalturaScheduledTaskProfileStatus.ACTIVE=2;KalturaScheduledTaskProfileStatus.DELETED=3;KalturaScheduledTaskProfileStatus.SUSPENDED=4;KalturaScheduledTaskProfileStatus.DRY_RUN_ONLY=5;function KalturaSchedulerStatusType(){}
KalturaSchedulerStatusType.RUNNING_BATCHES_COUNT=1;KalturaSchedulerStatusType.RUNNING_BATCHES_CPU=2;KalturaSchedulerStatusType.RUNNING_BATCHES_MEMORY=3;KalturaSchedulerStatusType.RUNNING_BATCHES_NETWORK=4;KalturaSchedulerStatusType.RUNNING_BATCHES_DISC_IO=5;KalturaSchedulerStatusType.RUNNING_BATCHES_DISC_SPACE=6;KalturaSchedulerStatusType.RUNNING_BATCHES_IS_RUNNING=7;function KalturaSearchOperatorType(){}
...
KalturaUserStatus.BLOCKED=0;KalturaUserStatus.ACTIVE=1;KalturaUserStatus.DELETED=2;function KalturaUserType(){}
KalturaUserType.USER=0;KalturaUserType.GROUP=1;function KalturaVirusFoundAction(){}
...
KalturaAccessControlProfileOrderBy.CREATED_AT_ASC="+createdAt";KalturaAccessControlProfileOrderBy.UPDATED_AT_ASC="+updatedAt";KalturaAccessControlProfileOrderBy.CREATED_AT_DESC="-createdAt";KalturaAccessControlProfileOrderBy.UPDATED_AT_DESC="-updatedAt";function KalturaActivitiBusinessProcessServerOrderBy(){}
KalturaActivitiBusinessProcessServerOrderBy.CREATED_AT_ASC="+createdAt";KalturaActivitiBusinessProcessServerOrderBy.UPDATED_AT_ASC="+updatedAt";KalturaActivitiBusinessProcessServerOrderBy.CREATED_AT_DESC="-createdAt";KalturaActivitiBusinessProcessServerOrderBy.UPDATED_AT_DESC="-updatedAt";function KalturaActivitiBusinessProcessServerProtocol(){}
KalturaActivitiBusinessProcessServerProtocol.HTTP="http";KalturaActivitiBusinessProcessServerProtocol.HTTPS="https";function KalturaAdCuePointOrderBy(){}
...
KalturaBaseSyndicationFeedOrderBy.CREATED_AT_ASC="+createdAt";KalturaBaseSyndicationFeedOrderBy.NAME_ASC="+name";KalturaBaseSyndicationFeedOrderBy.PLAYLIST_ID_ASC="+playlistId";KalturaBaseSyndicationFeedOrderBy.TYPE_ASC="+type";KalturaBaseSyndicationFeedOrderBy.UPDATED_AT_ASC="+updatedAt";KalturaBaseSyndicationFeedOrderBy.CREATED_AT_DESC="-createdAt";KalturaBaseSyndicationFeedOrderBy.NAME_DESC="-name";KalturaBaseSyndicationFeedOrderBy.PLAYLIST_ID_DESC="-playlistId";KalturaBaseSyndicationFeedOrderBy.TYPE_DESC="-type";KalturaBaseSyndicationFeedOrderBy.UPDATED_AT_DESC="-updatedAt";function KalturaBatchJobObjectType(){}
KalturaBatchJobObjectType.ENTRY_DISTRIBUTION="contentDistribution.EntryDistribution";KalturaBatchJobObjectType.DROP_FOLDER_FILE="dropFolderXmlBulkUpload.DropFolderFile";KalturaBatchJobObjectType.METADATA="metadata.Metadata";KalturaBatchJobObjectType.METADATA_PROFILE="metadata.MetadataProfile";KalturaBatchJobObjectType.SCHEDULED_TASK_PROFILE="scheduledTask.ScheduledTaskProfile";KalturaBatchJobObjectType.ENTRY="1";KalturaBatchJobObjectType.CATEGORY="2";KalturaBatchJobObjectType.FILE_SYNC="3";KalturaBatchJobObjectType.ASSET="4";function KalturaBatchJobOrderBy(){}
...
KalturaBulkUploadType.CSV="bulkUploadCsv.CSV";KalturaBulkUploadType.FILTER="bulkUploadFilter.FILTER";KalturaBulkUploadType.XML="bulkUploadXml.XML";KalturaBulkUploadType.DROP_FOLDER_XML="dropFolderXmlBulkUpload.DROP_FOLDER_XML";function KalturaBusinessProcessAbortNotificationTemplateOrderBy(){}
KalturaBusinessProcessAbortNotificationTemplateOrderBy.CREATED_AT_ASC="+createdAt";KalturaBusinessProcessAbortNotificationTemplateOrderBy.ID_ASC="+id";KalturaBusinessProcessAbortNotificationTemplateOrderBy.UPDATED_AT_ASC="+updatedAt";KalturaBusinessProcessAbortNotificationTemplateOrderBy.CREATED_AT_DESC="-createdAt";KalturaBusinessProcessAbortNotificationTemplateOrderBy.ID_DESC="-id";KalturaBusinessProcessAbortNotificationTemplateOrderBy.UPDATED_AT_DESC="-updatedAt";function KalturaBusinessProcessNotificationTemplateOrderBy(){}
KalturaBusinessProcessNotificationTemplateOrderBy.CREATED_AT_ASC="+createdAt";KalturaBusinessProcessNotificationTemplateOrderBy.ID_ASC="+id";KalturaBusinessProcessNotificationTemplateOrderBy.UPDATED_AT_ASC="+updatedAt";KalturaBusinessProcessNotificationTemplateOrderBy.CREATED_AT_DESC="-createdAt";KalturaBusinessProcessNotificationTemplateOrderBy.ID_DESC="-id";KalturaBusinessProcessNotificationTemplateOrderBy.UPDATED_AT_DESC="-updatedAt";function KalturaBusinessProcessProvider(){}
KalturaBusinessProcessProvider.ACTIVITI="activitiBusinessProcessNotification.Activiti";function KalturaBusinessProcessServerOrderBy(){}
KalturaBusinessProcessServerOrderBy.CREATED_AT_ASC="+createdAt";KalturaBusinessProcessServerOrderBy.UPDATED_AT_ASC="+updatedAt";KalturaBusinessProcessServerOrderBy.CREATED_AT_DESC="-createdAt";KalturaBusinessProcessServerOrderBy.UPDATED_AT_DESC="-updatedAt";function KalturaBusinessProcessServerStatus(){}
KalturaBusinessProcessServerStatus.DISABLED="1";KalturaBusinessProcessServerStatus.ENABLED="2";KalturaBusinessProcessServerStatus.DELETED="3";function KalturaBusinessProcessSignalNotificationTemplateOrderBy(){}
KalturaBusinessProcessSignalNotificationTemplateOrderBy.CREATED_AT_ASC="+createdAt";KalturaBusinessProcessSignalNotificationTemplateOrderBy.ID_ASC="+id";KalturaBusinessProcessSignalNotificationTemplateOrderBy.UPDATED_AT_ASC="+updatedAt";KalturaBusinessProcessSignalNotificationTemplateOrderBy.CREATED_AT_DESC="-createdAt";KalturaBusinessProcessSignalNotificationTemplateOrderBy.ID_DESC="-id";KalturaBusinessProcessSignalNotificationTemplateOrderBy.UPDATED_AT_DESC="-updatedAt";function KalturaBusinessProcessStartNotificationTemplateOrderBy(){}
KalturaBusinessProcessStartNotificationTemplateOrderBy.CREATED_AT_ASC="+createdAt";KalturaBusinessProcessStartNotificationTemplateOrderBy.ID_ASC="+id";KalturaBusinessProcessStartNotificationTemplateOrderBy.UPDATED_AT_ASC="+updatedAt";KalturaBusinessProcessStartNotificationTemplateOrderBy.CREATED_AT_DESC="-createdAt";KalturaBusinessProcessStartNotificationTemplateOrderBy.ID_DESC="-id";KalturaBusinessProcessStartNotificationTemplateOrderBy.UPDATED_AT_DESC="-updatedAt";function KalturaCaptionAssetOrderBy(){}
...
KalturaContainerFormat._3GP="3gp";KalturaContainerFormat.APPLEHTTP="applehttp";KalturaContainerFormat.AVI="avi";KalturaContainerFormat.BMP="bmp";KalturaContainerFormat.COPY="copy";KalturaContainerFormat.FLV="flv";KalturaContainerFormat.HLS="hls";KalturaContainerFormat.ISMV="ismv";KalturaContainerFormat.JPG="jpg";KalturaContainerFormat.M2TS="m2ts";KalturaContainerFormat.M4V="m4v";KalturaContainerFormat.MKV="mkv";KalturaContainerFormat.MOV="mov";KalturaContainerFormat.MP3="mp3";KalturaContainerFormat.MP4="mp4";KalturaContainerFormat.MPEG="mpeg";KalturaContainerFormat.MPEGTS="mpegts";KalturaContainerFormat.MXF="mxf";KalturaContainerFormat.OGG="ogg";KalturaContainerFormat.OGV="ogv";KalturaContainerFormat.PDF="pdf";KalturaContainerFormat.PNG="png";KalturaContainerFormat.SWF="swf";KalturaContainerFormat.WAV="wav";KalturaContainerFormat.WEBM="webm";KalturaContainerFormat.WMA="wma";KalturaContainerFormat.WMV="wmv";KalturaContainerFormat.WVM="wvm";function KalturaContextType(){}
...
KalturaDropFolderType.FEED="FeedDropFolder.FEED";KalturaDropFolderType.WEBEX="WebexDropFolder.WEBEX";KalturaDropFolderType.LOCAL="1";KalturaDropFolderType.FTP="2";KalturaDropFolderType.SCP="3";KalturaDropFolderType.SFTP="4";KalturaDropFolderType.S3="6";function KalturaDurationType(){}
...
KalturaEventNotificationTemplateType.BPM_ABORT="businessProcessNotification.BusinessProcessAbort";KalturaEventNotificationTemplateType.BPM_SIGNAL="businessProcessNotification.BusinessProcessSignal";KalturaEventNotificationTemplateType.BPM_START="businessProcessNotification.BusinessProcessStart";KalturaEventNotificationTemplateType.EMAIL="emailNotification.Email";KalturaEventNotificationTemplateType.HTTP="httpNotification.Http";function KalturaEventType(){}
...
KalturaIntegrationTriggerType.BPM_EVENT_NOTIFICATION="bpmEventNotificationIntegration.BpmEventNotification";function KalturaKontikiStorageProfileOrderBy(){}
...
KalturaLiveReportOrderBy.NAME_ASC="+name";KalturaLiveReportOrderBy.AUDIENCE_DESC="-audience";KalturaLiveReportOrderBy.EVENT_TIME_DESC="-eventTime";KalturaLiveReportOrderBy.PLAYS_DESC="-plays";function KalturaLiveReportType(){}
...
KalturaMediaParserType.MEDIAINFO="0";KalturaMediaParserType.REMOTE_MEDIAINFO="remoteMediaInfo.RemoteMediaInfo";KalturaMediaParserType.FFMPEG="1";function KalturaMetadataObjectType(){}
KalturaMetadataObjectType.AD_CUE_POINT="adCuePointMetadata.AdCuePoint";KalturaMetadataObjectType.ANNOTATION="annotationMetadata.Annotation";KalturaMetadataObjectType.CODE_CUE_POINT="codeCuePointMetadata.CodeCuePoint";KalturaMetadataObjectType.THUMB_CUE_POINT="thumbCuePointMetadata.thumbCuePoint";KalturaMetadataObjectType.ENTRY="1";KalturaMetadataObjectType.CATEGORY="2";KalturaMetadataObjectType.USER="3";KalturaMetadataObjectType.PARTNER="4";KalturaMetadataObjectType.DYNAMIC_OBJECT="5";function KalturaMetadataOrderBy(){}
...
KalturaReportOrderBy.CREATED_AT_ASC="+createdAt";KalturaReportOrderBy.CREATED_AT_DESC="-createdAt";function KalturaResponseProfileOrderBy(){}
KalturaResponseProfileOrderBy.CREATED_AT_ASC="+createdAt";KalturaResponseProfileOrderBy.UPDATED_AT_ASC="+updatedAt";KalturaResponseProfileOrderBy.CREATED_AT_DESC="-createdAt";KalturaResponseProfileOrderBy.UPDATED_AT_DESC="-updatedAt";function KalturaRuleActionType(){}
...
KalturaSyndicationDistributionProfileOrderBy.CREATED_AT_ASC="+createdAt";KalturaSyndicationDistributionProfileOrderBy.UPDATED_AT_ASC="+updatedAt";KalturaSyndicationDistributionProfileOrderBy.CREATED_AT_DESC="-createdAt";KalturaSyndicationDistributionProfileOrderBy.UPDATED_AT_DESC="-updatedAt";function KalturaSyndicationFeedEntriesOrderBy(){}
...
KalturaAccessControlContextTypeHolder.inheritsFrom(KalturaContextTypeHolder);function KalturaRuleAction(){this.type=null;}
...
KalturaAccessControlProfile.inheritsFrom(KalturaObjectBase);function KalturaKeyValue(){this.key=null;this.value=null;}
...
KalturaCuePoint.inheritsFrom(KalturaObjectBase);function KalturaAnnotation(){this.parentId=null;this.text=null;this.endTime=null;this.duration=null;this.depth=null;this.childrenCount=null;this.directChildrenCount=null;this.isPublic=null;this.searchableOnEntry=null;}
KalturaAnnotation.inheritsFrom(KalturaCuePoint);function KalturaApiExceptionArg(){this.name=null;this.value=null;}
KalturaApiExceptionArg.inheritsFrom(KalturaObjectBase);function KalturaAsset(){this.id=null;this.entryId=null;this.partnerId=null;this.version=null;this.size=null;this.tags=null;this.fileExt=null;this.createdAt=null;this.updatedAt=null;this.deletedAt=null;this.description=null;this.partnerData=null;this.partnerDescription=null;this.actualSourceAssetParamsIds=null;}
...
KalturaAttachmentAsset.inheritsFrom(KalturaAsset);function KalturaAuditTrailInfo(){}
...
KalturaAuditTrailChangeItem.inheritsFrom(KalturaObjectBase);function KalturaOperationAttributes(){}
...
KalturaBaseEntry.inheritsFrom(KalturaObjectBase);function KalturaBaseResponseProfile(){}
KalturaBaseResponseProfile.inheritsFrom(KalturaObjectBase);function KalturaBaseSyndicationFeed(){this.id=null;this.feedUrl=null;this.partnerId=null;this.playlistId=null;this.name=null;this.status=null;this.type=null;this.landingPage=null;this.createdAt=null;this.allowEmbed=null;this.playerUiconfId=null;this.flavorParamId=null;this.transcodeExistingContent=null;this.addToDefaultConversionProfile=null;this.categories=null;this.storageId=null;this.entriesOrderBy=null;this.enforceEntitlement=null;this.privacyContext=null;this.updatedAt=null;}
KalturaBaseSyndicationFeed.inheritsFrom(KalturaObjectBase);function KalturaBatchHistoryData(){this.schedulerId=null;this.workerId=null;this.batchIndex=null;this.timeStamp=null;this.message=null;this.errType=null;this.errNumber=null;this.hostName=null;this.sessionId=null;}
KalturaBatchHistoryData.inheritsFrom(KalturaObjectBase);function KalturaJobData(){}
KalturaJobData.inheritsFrom(KalturaObjectBase);function KalturaBatchJob(){this.id=null;this.partnerId=null;this.createdAt=null;this.updatedAt=null;this.deletedAt=null;this.lockExpiration=null;this.executionAttempts=null;this.lockVersion=null;this.entryId=null;this.entryName=null;this.jobType=null;this.jobSubType=null;this.data=null;this.status=null;this.abort=null;this.checkAgainTimeout=null;this.message=null;this.description=null;this.priority=null;this.history=null;this.bulkJobId=null;this.batchVersion=null;this.parentJobId=null;this.rootJobId=null;this.queueTime=null;this.finishTime=null;this.errType=null;this.errNumber=null;this.estimatedEffort=null;this.urgency=null;this.schedulerId=null;this.workerId=null;this.batchIndex=null;this.lastSchedulerId=null;this.lastWorkerId=null;this.dc=null;this.jobObjectId=null;this.jobObjectType=null;}
KalturaBatchJob.inheritsFrom(KalturaObjectBase);function KalturaBulkServiceData(){}
...
KalturaBulkUpload.inheritsFrom(KalturaObjectBase);function KalturaBulkUploadObjectData(){}
KalturaBulkUploadObjectData.inheritsFrom(KalturaObjectBase);function KalturaBusinessProcessCase(){this.id=null;this.businessProcessId=null;this.businessProcessStartNotificationTemplateId=null;this.suspended=null;this.activityId=null;}
KalturaBusinessProcessCase.inheritsFrom(KalturaObjectBase);function KalturaBusinessProcessServer(){this.id=null;this.createdAt=null;this.updatedAt=null;this.partnerId=null;this.name=null;this.systemName=null;this.description=null;this.status=null;this.type=null;}
KalturaBusinessProcessServer.inheritsFrom(KalturaObjectBase);function KalturaCEError(){this.id=null;this.partnerId=null;this.browser=null;this.serverIp=null;this.serverOs=null;this.phpVersion=null;this.ceAdminEmail=null;this.type=null;this.description=null;this.data=null;}
...
KalturaCategoryEntry.inheritsFrom(KalturaObjectBase);function KalturaCategoryUser(){this.categoryId=null;this.userId=null;this.partnerId=null;this.permissionLevel=null;this.status=null;this.createdAt=null;this.updatedAt=null;this.updateMethod=null;this.categoryFullIds=null;this.permissionNames=null;}
KalturaCategoryUser.inheritsFrom(KalturaObjectBase);function KalturaClientConfiguration(){this.clientTag=null;this.apiVersion=null;}
KalturaClientConfiguration.inheritsFrom(KalturaObjectBase);function KalturaClientNotification(){this.url=null;this.data=null;}
...
KalturaContextDataResult.inheritsFrom(KalturaObjectBase);function KalturaControlPanelCommand(){this.id=null;this.createdAt=null;this.createdBy=null;this.updatedAt=null;this.updatedBy=null;this.createdById=null;this.schedulerId=null;this.workerId=null;this.workerConfiguredId=null;this.workerName=null;this.batchIndex=null;this.type=null;this.targetType=null;this.status=null;this.cause=null;this.description=null;this.errorDescription=null;}
KalturaControlPanelCommand.inheritsFrom(KalturaObjectBase);function KalturaConversionAttribute(){this.flavorParamsId=null;this.name=null;this.value=null;}
...
KalturaConversionProfileAssetParams.inheritsFrom(KalturaObjectBase);function KalturaConvertCollectionFlavorData(){this.flavorAssetId=null;this.flavorParamsOutputId=null;this.readyBehavior=null;this.videoBitrate=null;this.audioBitrate=null;this.destFileSyncLocalPath=null;this.destFileSyncRemoteUrl=null;}
...
KalturaCoordinate.inheritsFrom(KalturaObjectBase);function KalturaDataEntry(){this.dataContent=null;this.retrieveDataContentByGet=null;}
KalturaDataEntry.inheritsFrom(KalturaBaseEntry);function KalturaUrlRecognizer(){this.hosts=null;this.uriPrefix=null;}
KalturaUrlRecognizer.inheritsFrom(KalturaObjectBase);function KalturaUrlTokenizer(){this.window=null;this.key=null;}
KalturaUrlTokenizer.inheritsFrom(KalturaObjectBase);function KalturaDeliveryProfile(){this.id=null;this.partnerId=null;this.name=null;this.type=null;this.systemName=null;this.description=null;this.createdAt=null;this.updatedAt=null;this.streamerType=null;this.url=null;this.hostName=null;this.status=null;this.recognizer=null;this.tokenizer=null;this.isDefault=null;this.parentId=null;this.mediaProtocols=null;this.priority=null;}
KalturaDeliveryProfile.inheritsFrom(KalturaObjectBase);function KalturaFileSyncDescriptor(){this.fileSyncLocalPath=null;this.fileSyncRemoteUrl=null;this.fileSyncObjectSubType=null;}
KalturaFileSyncDescriptor.inheritsFrom(KalturaObjectBase);function KalturaDestFileSyncDescriptor(){}
KalturaDestFileSyncDescriptor.inheritsFrom(KalturaFileSyncDescriptor);function KalturaSearchItem(){}
KalturaSearchItem.inheritsFrom(KalturaObjectBase);function KalturaFilter(){this.orderBy=null;this.advancedSearch=null;}
KalturaFilter.inheritsFrom(KalturaObjectBase);function KalturaRelatedFilter(){}
KalturaRelatedFilter.inheritsFrom(KalturaFilter);function KalturaFilterPager(){this.pageSize=null;this.pageIndex=null;}
KalturaFilterPager.inheritsFrom(KalturaObjectBase);function KalturaResponseProfileMapping(){this.parentProperty=null;this.filterProperty=null;this.allowNull=null;}
KalturaResponseProfileMapping.inheritsFrom(KalturaObjectBase);function KalturaDetachedResponseProfile(){this.name=null;this.type=null;this.fields=null;this.filter=null;this.pager=null;this.relatedProfiles=null;this.mappings=null;}
KalturaDetachedResponseProfile.inheritsFrom(KalturaBaseResponseProfile);function KalturaDistributionFieldConfig(){this.fieldName=null;this.userFriendlyFieldName=null;this.entryMrssXslt=null;this.isRequired=null;this.updateOnChange=null;this.updateParams=null;this.isDefault=null;}
...
KalturaDistributionProfile.inheritsFrom(KalturaObjectBase);function KalturaDistributionProvider(){this.type=null;this.name=null;this.scheduleUpdateEnabled=null;this.availabilityUpdateEnabled=null;this.deleteInsteadUpdate=null;this.intervalBeforeSunrise=null;this.intervalBeforeSunset=null;this.updateRequiredEntryFields=null;this.updateRequiredMetadataXPaths=null;}
KalturaDistributionProvider.inheritsFrom(KalturaObjectBase);function KalturaDistributionRemoteMediaFile(){this.version=null;this.assetId=null;this.remoteId=null;}
...
KalturaDocumentEntry.inheritsFrom(KalturaBaseEntry);function KalturaDrmPolicy(){this.id=null;this.partnerId=null;this.name=null;this.systemName=null;this.description=null;this.provider=null;this.status=null;this.scenario=null;this.licenseType=null;this.licenseExpirationPolicy=null;this.duration=null;this.createdAt=null;this.updatedAt=null;}
KalturaDrmPolicy.inheritsFrom(KalturaObjectBase);function KalturaDrmProfile(){this.id=null;this.partnerId=null;this.name=null;this.description=null;this.provider=null;this.status=null;this.licenseServerUrl=null;this.defaultPolicy=null;this.createdAt=null;this.updatedAt=null;}
KalturaDrmProfile.inheritsFrom(KalturaObjectBase);function KalturaDropFolderFileHandlerConfig(){this.handlerType=null;}
...
KalturaDropFolderFile.inheritsFrom(KalturaObjectBase);function KalturaEmailIngestionProfile(){this.id=null;this.name=null;this.description=null;this.emailAddress=null;this.mailboxId=null;this.partnerId=null;this.conversionProfile2Id=null;this.moderationStatus=null;this.status=null;this.createdAt=null;this.defaultCategory=null;this.defaultUserId=null;this.defaultTags=null;this.defaultAdminTags=null;this.maxAttachmentSizeKbytes=null;this.maxAttachmentsPerMail=null;}
...
KalturaEntryDistribution.inheritsFrom(KalturaObjectBase);function KalturaEntryReplacementOptions(){this.keepManualThumbnails=null;}
...
KalturaEventNotificationTemplate.inheritsFrom(KalturaObjectBase);function KalturaObjectIdentifier(){this.extendedFeatures=null;}
...
KalturaExternalMediaEntry.inheritsFrom(KalturaMediaEntry);function KalturaFeatureStatus(){this.type=null;this.value=null;}
KalturaFeatureStatus.inheritsFrom(KalturaObjectBase);function KalturaFeedItemInfo(){this.itemXPath=null;this.itemPublishDateXPath=null;this.itemUniqueIdentifierXPath=null;this.itemContentFileSizeXPath=null;this.itemContentUrlXPath=null;this.itemContentBitrateXPath=null;this.itemHashXPath=null;this.itemContentXpath=null;this.contentBitrateAttributeName=null;}
KalturaFeedItemInfo.inheritsFrom(KalturaObjectBase);function KalturaFileAsset(){this.id=null;this.partnerId=null;this.fileAssetObjectType=null;this.objectId=null;this.name=null;this.systemName=null;this.fileExt=null;this.version=null;this.createdAt=null;this.updatedAt=null;this.status=null;}
KalturaFileAsset.inheritsFrom(KalturaObjectBase);function KalturaFileSync(){this.id=null;this.partnerId=null;this.fileObjectType=null;this.objectId=null;this.version=null;this.objectSubType=null;this.dc=null;this.original=null;this.createdAt=null;this.updatedAt=null;this.readyAt=null;this.syncTime=null;this.status=null;this.fileType=null;this.linkedId=null;this.linkCount=null;this.fileRoot=null;this.filePath=null;this.fileSize=null;this.fileUrl=null;this.fileContent=null;this.fileDiscSize=null;this.isCurrentDc=null;}
KalturaFileSync.inheritsFrom(KalturaObjectBase);function KalturaFlavorAsset(){this.flavorParamsId=null;this.width=null;this.height=null;this.bitrate=null;this.frameRate=null;this.isOriginal=null;this.isWeb=null;this.containerFormat=null;this.videoCodecId=null;this.status=null;}
KalturaFlavorAsset.inheritsFrom(KalturaAsset);function KalturaFlavorAssetUrlOptions(){this.fileName=null;}
KalturaFlavorAssetUrlOptions.inheritsFrom(KalturaObjectBase);function KalturaFlavorParams(){this.videoCodec=null;this.videoBitrate=null;this.audioCodec=null;this.audioBitrate=null;this.audioChannels=null;this.audioSampleRate=null;this.width=null;this.height=null;this.frameRate=null;this.gopSize=null;this.conversionEngines=null;this.conversionEnginesExtraParams=null;this.twoPass=null;this.deinterlice=null;this.rotate=null;this.operators=null;this.engineVersion=null;this.format=null;this.aspectRatioProcessingMode=null;this.forceFrameToMultiplication16=null;this.isGopInSec=null;this.isAvoidVideoShrinkFramesizeToSource=null;this.isAvoidVideoShrinkBitrateToSource=null;this.isVideoFrameRateForLowBrAppleHls=null;this.multiStream=null;this.anamorphicPixels=null;this.isAvoidForcedKeyFrames=null;this.isCropIMX=null;this.optimizationPolicy=null;this.maxFrameRate=null;this.videoConstantBitrate=null;this.videoBitrateTolerance=null;this.watermarkData=null;this.clipOffset=null;this.clipDuration=null;}
...
KalturaFlavorAssetWithParams.inheritsFrom(KalturaObjectBase);function KalturaFlavorParamsOutput(){this.flavorParamsId=null;this.commandLinesStr=null;this.flavorParamsVersion=null;this.flavorAssetId=null;this.flavorAssetVersion=null;this.readyBehavior=null;}
KalturaFlavorParamsOutput.inheritsFrom(KalturaFlavorParams);function KalturaGenericDistributionProfileAction(){this.protocol=null;this.serverUrl=null;this.serverPath=null;this.username=null;this.password=null;this.ftpPassiveMode=null;this.httpFieldName=null;this.httpFileName=null;}
...
KalturaGenericDistributionProviderAction.inheritsFrom(KalturaObjectBase);function KalturaGenericDistributionProvider(){this.id=null;this.createdAt=null;this.updatedAt=null;this.partnerId=null;this.isDefault=null;this.status=null;this.optionalFlavorParamsIds=null;this.requiredFlavorParamsIds=null;this.optionalThumbDimensions=null;this.requiredThumbDimensions=null;this.editableFields=null;this.mandatoryFields=null;}
KalturaGenericDistributionProvider.inheritsFrom(KalturaDistributionProvider);function KalturaGroupUser(){this.userId=null;this.groupId=null;this.status=null;this.partnerId=null;this.createdAt=null;this.updatedAt=null;}
KalturaGroupUser.inheritsFrom(KalturaObjectBase);function KalturaObject(){this.relatedObjects=null;}
...
KalturaIntegerValue.inheritsFrom(KalturaValue);function KalturaIntegrationJobProviderData(){}
KalturaIntegrationJobProviderData.inheritsFrom(KalturaObjectBase);function KalturaIntegrationJobTriggerData(){}
KalturaIntegrationJobTriggerData.inheritsFrom(KalturaObjectBase);function KalturaLiveStreamConfiguration(){this.protocol=null;this.url=null;this.publishUrl=null;this.backupUrl=null;this.streamName=null;}
...
KalturaLiveReportExportResponse.inheritsFrom(KalturaObjectBase);function KalturaLiveReportInputFilter(){this.entryIds=null;this.fromTime=null;this.toTime=null;this.live=null;this.orderBy=null;}
KalturaLiveReportInputFilter.inheritsFrom(KalturaObjectBase);function KalturaLiveStats(){this.audience=null;this.dvrAudience=null;this.avgBitrate=null;this.bufferTime=null;this.plays=null;this.secondsViewed=null;this.startEvent=null;this.timestamp=null;}
KalturaLiveStats.inheritsFrom(KalturaObjectBase);function KalturaLiveStatsEvent(){this.partnerId=null;this.entryId=null;this.eventType=null;this.sessionId=null;this.eventIndex=null;this.bufferTime=null;this.bitrate=null;this.referrer=null;this.isLive=null;this.startTime=null;this.deliveryType=null;}
KalturaLiveStatsEvent.inheritsFrom(KalturaObjectBase);function KalturaLiveStreamBitrate(){this.bitrate=null;this.width=null;this.height=null;this.tags=null;}
...
KalturaMediaInfo.inheritsFrom(KalturaObjectBase);function KalturaMediaServer(){this.id=null;this.dc=null;this.hostname=null;this.createdAt=null;this.updatedAt=null;}
...
KalturaMetadataProfileField.inheritsFrom(KalturaObjectBase);function KalturaMixEntry(){this.hasRealThumbnail=null;this.editorType=null;this.dataContent=null;}
KalturaMixEntry.inheritsFrom(KalturaPlayableEntry);function KalturaModerationFlag(){this.id=null;this.partnerId=null;this.userId=null;this.moderationObjectType=null;this.flaggedEntryId=null;this.flaggedUserId=null;this.status=null;this.comments=null;this.flagType=null;this.createdAt=null;this.updatedAt=null;}
KalturaModerationFlag.inheritsFrom(KalturaObjectBase);function KalturaObjectTask(){this.type=null;this.stopProcessingOnError=null;}
...
KalturaPartner.inheritsFrom(KalturaObjectBase);function KalturaPartnerStatistics(){this.packageBandwidthAndStorage=null;this.hosting=null;this.bandwidth=null;this.usage=null;this.usagePercent=null;this.reachedLimitDate=null;}
...
KalturaPartnerUsage.inheritsFrom(KalturaObjectBase);function KalturaPermission(){this.id=null;this.type=null;this.name=null;this.friendlyName=null;this.description=null;this.status=null;this.partnerId=null;this.dependsOnPermissionNames=null;this.tags=null;this.permissionItemsIds=null;this.createdAt=null;this.updatedAt=null;this.partnerGroup=null;}
...
KalturaPermissionItem.inheritsFrom(KalturaObjectBase);function KalturaPlayReadyAnalogVideoOPIdHolder(){this.type=null;}
...
KalturaPlaylist.inheritsFrom(KalturaBaseEntry);function KalturaRemotePath(){this.storageProfileId=null;this.uri=null;}
KalturaRemotePath.inheritsFrom(KalturaObjectBase);function KalturaUrlResource(){this.url=null;this.forceAsyncDownload=null;}
KalturaUrlResource.inheritsFrom(KalturaContentResource);function KalturaRemoteStorageResource(){this.storageProfileId=null;}
KalturaRemoteStorageResource.inheritsFrom(KalturaUrlResource);function KalturaReport(){this.id=null;this.partnerId=null;this.name=null;this.systemName=null;this.description=null;this.query=null;this.createdAt=null;this.updatedAt=null;}
KalturaReport.inheritsFrom(KalturaObjectBase);function KalturaReportBaseTotal(){this.id=null;this.data=null;}
...
KalturaReportTotal.inheritsFrom(KalturaObjectBase);function KalturaRequestConfiguration(){this.partnerId=null;this.ks=null;this.responseProfile=null;}
KalturaRequestConfiguration.inheritsFrom(KalturaObjectBase);function KalturaResponseProfile(){this.id=null;this.systemName=null;this.partnerId=null;this.createdAt=null;this.updatedAt=null;this.status=null;}
...
KalturaScheduledTaskProfile.inheritsFrom(KalturaObjectBase);function KalturaSchedulerStatus(){this.id=null;this.schedulerConfiguredId=null;this.workerConfiguredId=null;this.workerType=null;this.type=null;this.value=null;this.schedulerId=null;this.workerId=null;}
KalturaSchedulerStatus.inheritsFrom(KalturaObjectBase);function KalturaSchedulerConfig(){this.id=null;this.createdBy=null;this.updatedBy=null;this.commandId=null;this.commandStatus=null;this.schedulerId=null;this.schedulerConfiguredId=null;this.schedulerName=null;this.workerId=null;this.workerConfiguredId=null;this.workerName=null;this.variable=null;this.variablePart=null;this.value=null;}
KalturaSchedulerConfig.inheritsFrom(KalturaObjectBase);function KalturaSchedulerWorker(){this.id=null;this.configuredId=null;this.schedulerId=null;this.schedulerConfiguredId=null;this.type=null;this.typeName=null;this.name=null;this.statuses=null;this.configs=null;this.lockedJobs=null;this.avgWait=null;this.avgWork=null;this.lastStatus=null;this.lastStatusStr=null;}
KalturaSchedulerWorker.inheritsFrom(KalturaObjectBase);function KalturaScheduler(){this.id=null;this.configuredId=null;this.name=null;this.host=null;this.statuses=null;this.configs=null;this.workers=null;this.createdAt=null;this.lastStatus=null;this.lastStatusStr=null;}
KalturaScheduler.inheritsFrom(KalturaObjectBase);function KalturaScope(){}
...
KalturaShortLink.inheritsFrom(KalturaObjectBase);function KalturaSourceFileSyncDescriptor(){this.actualFileSyncLocalPath=null;this.assetId=null;this.assetParamsId=null;}
...
KalturaTag.inheritsFrom(KalturaObjectBase);function KalturaThumbAsset(){this.thumbParamsId=null;this.width=null;this.height=null;this.status=null;}
...
KalturaThumbParams.inheritsFrom(KalturaAssetParams);function KalturaThumbParamsOutput(){this.thumbParamsId=null;this.thumbParamsVersion=null;this.thumbAssetId=null;this.thumbAssetVersion=null;this.rotate=null;}
KalturaThumbParamsOutput.inheritsFrom(KalturaThumbParams);function KalturaThumbnailServeOptions(){this.download=null;}
...
KalturaUiConf.inheritsFrom(KalturaObjectBase);function KalturaUiConfTypeInfo(){this.type=null;this.versions=null;this.directory=null;this.filename=null;}
...
KalturaUploadToken.inheritsFrom(KalturaObjectBase);function KalturaUser(){this.id=null;this.partnerId=null;this.type=null;this.screenName=null;this.fullName=null;this.email=null;this.dateOfBirth=null;this.country=null;this.state=null;this.city=null;this.zip=null;this.thumbnailUrl=null;this.description=null;this.tags=null;this.adminTags=null;this.gender=null;this.status=null;this.createdAt=null;this.updatedAt=null;this.partnerData=null;this.indexedPartnerDataInt=null;this.indexedPartnerDataString=null;this.storageSize=null;this.password=null;this.firstName=null;this.lastName=null;this.isAdmin=null;this.language=null;this.lastLoginTime=null;this.statusUpdatedAt=null;this.deletedAt=null;this.loginEnabled=null;this.roleIds=null;this.roleNames=null;this.isAccountOwner=null;this.allowedPartnerIds=null;this.allowedPartnerPackages=null;}
KalturaUser.inheritsFrom(KalturaObjectBase);function KalturaUserLoginData(){this.id=null;this.loginEmail=null;}
KalturaUserLoginData.inheritsFrom(KalturaObjectBase);function KalturaUserRole(){this.id=null;this.name=null;this.systemName=null;this.description=null;this.status=null;this.partnerId=null;this.permissionNames=null;this.tags=null;this.createdAt=null;this.updatedAt=null;}
KalturaUserRole.inheritsFrom(KalturaObjectBase);function KalturaVarPartnerUsageItem(){this.partnerId=null;this.partnerName=null;this.partnerStatus=null;this.partnerPackage=null;this.partnerCreatedAt=null;this.views=null;this.plays=null;this.entriesCount=null;this.totalEntriesCount=null;this.videoEntriesCount=null;this.imageEntriesCount=null;this.audioEntriesCount=null;this.mixEntriesCount=null;this.bandwidth=null;this.totalStorage=null;this.storage=null;this.deletedStorage=null;this.peakStorage=null;this.avgStorage=null;this.combinedStorageBandwidth=null;this.transcodingUsage=null;this.dateId=null;}
KalturaVarPartnerUsageItem.inheritsFrom(KalturaObjectBase);function KalturaVirusScanProfile(){this.id=null;this.createdAt=null;this.updatedAt=null;this.partnerId=null;this.name=null;this.status=null;this.engineType=null;this.entryFilter=null;this.actionIfInfected=null;}
KalturaVirusScanProfile.inheritsFrom(KalturaObjectBase);function KalturaWidget(){this.id=null;this.sourceWidgetId=null;this.rootWidgetId=null;this.partnerId=null;this.entryId=null;this.uiConfId=null;this.securityType=null;this.securityPolicy=null;this.createdAt=null;this.updatedAt=null;this.partnerData=null;this.widgetHTML=null;this.enforceEntitlement=null;this.privacyContext=null;this.addEmbedHtml5Support=null;}
KalturaWidget.inheritsFrom(KalturaObjectBase);function KalturaABCScreenersWatermarkCondition(){}
KalturaABCScreenersWatermarkCondition.inheritsFrom(KalturaCondition);function KalturaAccessControlBlockAction(){}
...
KalturaAccessControlLimitFlavorsAction.inheritsFrom(KalturaRuleAction);function KalturaAccessControlListResponse(){this.objects=null;}
KalturaAccessControlListResponse.inheritsFrom(KalturaListResponse);function KalturaAccessControlPlayReadyPolicyAction(){this.policyId=null;}
...
KalturaAccessControlPreviewAction.inheritsFrom(KalturaRuleAction);function KalturaAccessControlProfileListResponse(){this.objects=null;}
KalturaAccessControlProfileListResponse.inheritsFrom(KalturaListResponse);function KalturaActivitiBusinessProcessServer(){this.host=null;this.port=null;this.protocol=null;this.username=null;this.password=null;}
KalturaActivitiBusinessProcessServer.inheritsFrom(KalturaBusinessProcessServer);function KalturaAdCuePoint(){this.protocolType=null;this.sourceUrl=null;this.adType=null;this.title=null;this.endTime=null;this.duration=null;}
KalturaAdCuePoint.inheritsFrom(KalturaCuePoint);function KalturaAdminUser(){}
KalturaAdminUser.inheritsFrom(KalturaUser);function KalturaAmazonS3StorageProfile(){this.filesPermissionInS3=null;this.s3Region=null;}
KalturaAmazonS3StorageProfile.inheritsFrom(KalturaStorageProfile);function KalturaAnnotationListResponse(){this.objects=null;}
KalturaAnnotationListResponse.inheritsFrom(KalturaListResponse);function KalturaApiActionPermissionItem(){this.service=null;this.action=null;}
...
KalturaApiParameterPermissionItem.inheritsFrom(KalturaPermissionItem);function KalturaAssetDistributionPropertyCondition(){this.propertyName=null;this.propertyValue=null;}
KalturaAssetDistributionPropertyCondition.inheritsFrom(KalturaAssetDistributionCondition);function KalturaAssetParamsOutput(){this.assetParamsId=null;this.assetParamsVersion=null;this.assetId=null;this.assetVersion=null;this.readyBehavior=null;this.format=null;}
...
KalturaAssetsParamsResourceContainers.inheritsFrom(KalturaResource);function KalturaAttachmentAssetListResponse(){this.objects=null;}
KalturaAttachmentAssetListResponse.inheritsFrom(KalturaListResponse);function KalturaAuditTrailChangeInfo(){this.changedItems=null;}
...
KalturaBulkUploadUserData.inheritsFrom(KalturaBulkUploadObjectData);function KalturaBusinessProcessNotificationTemplate(){this.serverId=null;this.processId=null;this.mainObjectCode=null;}
KalturaBusinessProcessNotificationTemplate.inheritsFrom(KalturaEventNotificationTemplate);function KalturaBusinessProcessServerBaseFilter(){this.idEqual=null;this.idIn=null;this.idNotIn=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;this.partnerIdEqual=null;this.partnerIdIn=null;this.statusEqual=null;this.statusNotEqual=null;this.statusIn=null;this.statusNotIn=null;this.typeEqual=null;this.typeIn=null;}
KalturaBusinessProcessServerBaseFilter.inheritsFrom(KalturaFilter);function KalturaBusinessProcessServerListResponse(){this.objects=null;}
KalturaBusinessProcessServerListResponse.inheritsFrom(KalturaListResponse);function KalturaCaptionAssetItemListResponse(){this.objects=null;}
KalturaCaptionAssetItemListResponse.inheritsFrom(KalturaListResponse);function KalturaCaptionAssetListResponse(){this.objects=null;}
KalturaCaptionAssetListResponse.inheritsFrom(KalturaListResponse);function KalturaCaptionParamsListResponse(){this.objects=null;}
KalturaCaptionParamsListResponse.inheritsFrom(KalturaListResponse);function KalturaCaptureThumbJobData(){this.srcFileSyncLocalPath=null;this.actualSrcFileSyncLocalPath=null;this.srcFileSyncRemoteUrl=null;this.thumbParamsOutputId=null;this.thumbAssetId=null;this.srcAssetId=null;this.srcAssetType=null;this.thumbPath=null;}
KalturaCaptureThumbJobData.inheritsFrom(KalturaJobData);function KalturaCategoryEntryAdvancedFilter(){this.categoriesMatchOr=null;this.categoryEntryStatusIn=null;this.orderBy=null;this.categoryIdEqual=null;}
KalturaCategoryEntryAdvancedFilter.inheritsFrom(KalturaSearchItem);function KalturaCategoryEntryListResponse(){this.objects=null;}
KalturaCategoryEntryListResponse.inheritsFrom(KalturaListResponse);function KalturaCategoryIdentifier(){this.identifier=null;}
KalturaCategoryIdentifier.inheritsFrom(KalturaObjectIdentifier);function KalturaCategoryListResponse(){this.objects=null;}
KalturaCategoryListResponse.inheritsFrom(KalturaListResponse);function KalturaCategoryUserAdvancedFilter(){this.memberIdEq=null;this.memberIdIn=null;this.memberPermissionsMatchOr=null;this.memberPermissionsMatchAnd=null;}
KalturaCategoryUserAdvancedFilter.inheritsFrom(KalturaSearchItem);function KalturaCategoryUserListResponse(){this.objects=null;}
KalturaCategoryUserListResponse.inheritsFrom(KalturaListResponse);function KalturaCategoryUserProviderFilter(){this.userIdEqual=null;this.userIdIn=null;this.statusEqual=null;this.statusIn=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;this.updateMethodEqual=null;this.updateMethodIn=null;this.permissionNamesMatchAnd=null;this.permissionNamesMatchOr=null;}
...
KalturaControlPanelCommandBaseFilter.inheritsFrom(KalturaFilter);function KalturaControlPanelCommandListResponse(){this.objects=null;}
KalturaControlPanelCommandListResponse.inheritsFrom(KalturaListResponse);function KalturaConvartableJobData(){this.srcFileSyncLocalPath=null;this.actualSrcFileSyncLocalPath=null;this.srcFileSyncRemoteUrl=null;this.srcFileSyncs=null;this.engineVersion=null;this.flavorParamsOutputId=null;this.flavorParamsOutput=null;this.mediaInfoId=null;this.currentOperationSet=null;this.currentOperationIndex=null;this.pluginData=null;}
KalturaConvartableJobData.inheritsFrom(KalturaJobData);function KalturaConversionProfileAssetParamsListResponse(){this.objects=null;}
KalturaConversionProfileAssetParamsListResponse.inheritsFrom(KalturaListResponse);function KalturaConversionProfileListResponse(){this.objects=null;}
KalturaConversionProfileListResponse.inheritsFrom(KalturaListResponse);function KalturaConvertEntryFlavorsObjectTask(){this.flavorParamsIds=null;this.reconvert=null;}
...
KalturaCountryRestriction.inheritsFrom(KalturaBaseRestriction);function KalturaCuePointListResponse(){this.objects=null;}
KalturaCuePointListResponse.inheritsFrom(KalturaListResponse);function KalturaDataListResponse(){this.objects=null;}
KalturaDataListResponse.inheritsFrom(KalturaListResponse);function KalturaDeleteEntryFlavorsObjectTask(){this.deleteType=null;this.flavorParamsIds=null;}
...
KalturaDeliveryProfileGenericSilverLight.inheritsFrom(KalturaDeliveryProfile);function KalturaDeliveryProfileListResponse(){this.objects=null;}
KalturaDeliveryProfileListResponse.inheritsFrom(KalturaListResponse);function KalturaDeliveryProfileLiveAppleHttp(){this.disableExtraAttributes=null;this.forceProxy=null;}
...
KalturaDispatchEventNotificationObjectTask.inheritsFrom(KalturaObjectTask);function KalturaDistributeObjectTask(){this.distributionProfileId=null;}
...
KalturaDistributionProfileBaseFilter.inheritsFrom(KalturaFilter);function KalturaDistributionProfileListResponse(){this.objects=null;}
KalturaDistributionProfileListResponse.inheritsFrom(KalturaListResponse);function KalturaDistributionProviderBaseFilter(){this.typeEqual=null;this.typeIn=null;}
KalturaDistributionProviderBaseFilter.inheritsFrom(KalturaFilter);function KalturaDistributionProviderListResponse(){this.objects=null;}
KalturaDistributionProviderListResponse.inheritsFrom(KalturaListResponse);function KalturaDistributionValidationErrorConditionNotMet(){this.conditionName=null;}
...
KalturaDistributionValidationErrorMissingThumbnail.inheritsFrom(KalturaDistributionValidationError);function KalturaDocumentListResponse(){this.objects=null;}
KalturaDocumentListResponse.inheritsFrom(KalturaListResponse);function KalturaDrmDeviceBaseFilter(){this.partnerIdEqual=null;this.partnerIdIn=null;this.deviceIdLike=null;this.providerEqual=null;this.providerIn=null;}
...
KalturaDrmPolicyBaseFilter.inheritsFrom(KalturaFilter);function KalturaDrmPolicyListResponse(){this.objects=null;}
KalturaDrmPolicyListResponse.inheritsFrom(KalturaListResponse);function KalturaDrmProfileBaseFilter(){this.idEqual=null;this.idIn=null;this.partnerIdEqual=null;this.partnerIdIn=null;this.nameLike=null;this.providerEqual=null;this.providerIn=null;this.statusEqual=null;this.statusIn=null;}
KalturaDrmProfileBaseFilter.inheritsFrom(KalturaFilter);function KalturaDrmProfileListResponse(){this.objects=null;}
KalturaDrmProfileListResponse.inheritsFrom(KalturaListResponse);function KalturaDropFolderBaseFilter(){this.idEqual=null;this.idIn=null;this.partnerIdEqual=null;this.partnerIdIn=null;this.nameLike=null;this.typeEqual=null;this.typeIn=null;this.statusEqual=null;this.statusIn=null;this.conversionProfileIdEqual=null;this.conversionProfileIdIn=null;this.dcEqual=null;this.dcIn=null;this.pathEqual=null;this.pathLike=null;this.fileHandlerTypeEqual=null;this.fileHandlerTypeIn=null;this.fileNamePatternsLike=null;this.fileNamePatternsMultiLikeOr=null;this.fileNamePatternsMultiLikeAnd=null;this.tagsLike=null;this.tagsMultiLikeOr=null;this.tagsMultiLikeAnd=null;this.errorCodeEqual=null;this.errorCodeIn=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;}
...
KalturaEmailNotificationTemplate.inheritsFrom(KalturaEventNotificationTemplate);function KalturaUserBaseFilter(){this.partnerIdEqual=null;this.typeEqual=null;this.typeIn=null;this.screenNameLike=null;this.screenNameStartsWith=null;this.emailLike=null;this.emailStartsWith=null;this.tagsMultiLikeOr=null;this.tagsMultiLikeAnd=null;this.statusEqual=null;this.statusIn=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.firstNameStartsWith=null;this.lastNameStartsWith=null;this.isAdminEqual=null;}
KalturaUserBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaUserFilter(){this.idOrScreenNameStartsWith=null;this.idEqual=null;this.idIn=null;this.loginEnabledEqual=null;this.roleIdEqual=null;this.roleIdsEqual=null;this.roleIdsIn=null;this.firstNameOrLastNameStartsWith=null;this.permissionNamesMultiLikeOr=null;this.permissionNamesMultiLikeAnd=null;}
...
KalturaEmailNotificationUserRecipientProvider.inheritsFrom(KalturaEmailNotificationRecipientProvider);function KalturaEntryCaptionAssetSearchItem(){this.contentLike=null;this.contentMultiLikeOr=null;this.contentMultiLikeAnd=null;}
KalturaEntryCaptionAssetSearchItem.inheritsFrom(KalturaSearchItem);function KalturaEntryContext(){this.entryId=null;this.followEntryRedirect=null;}
...
KalturaEntryContextDataResult.inheritsFrom(KalturaContextDataResult);function KalturaEntryCuePointSearchFilter(){this.cuePointsFreeText=null;this.cuePointTypeIn=null;this.cuePointSubTypeEqual=null;}
KalturaEntryCuePointSearchFilter.inheritsFrom(KalturaSearchItem);function KalturaEntryDistributionListResponse(){this.objects=null;}
KalturaEntryDistributionListResponse.inheritsFrom(KalturaListResponse);function KalturaEntryIdentifier(){this.identifier=null;}
KalturaEntryIdentifier.inheritsFrom(KalturaObjectIdentifier);function KalturaEntryLiveStats(){this.entryId=null;this.peakAudience=null;this.peakDvrAudience=null;}
...
KalturaEventNotificationTemplateBaseFilter.inheritsFrom(KalturaFilter);function KalturaEventNotificationTemplateListResponse(){this.objects=null;}
KalturaEventNotificationTemplateListResponse.inheritsFrom(KalturaListResponse);function KalturaEventObjectChangedCondition(){this.modifiedColumns=null;}
...
KalturaExecuteMetadataXsltObjectTask.inheritsFrom(KalturaObjectTask);function KalturaExternalMediaEntryListResponse(){this.objects=null;}
KalturaExternalMediaEntryListResponse.inheritsFrom(KalturaListResponse);function KalturaFeatureStatusListResponse(){this.objects=null;}
KalturaFeatureStatusListResponse.inheritsFrom(KalturaListResponse);function KalturaFeedDropFolder(){this.itemHandlingLimit=null;this.feedItemInfo=null;}
KalturaFeedDropFolder.inheritsFrom(KalturaDropFolder);function KalturaFeedDropFolderFile(){this.hash=null;this.feedXmlPath=null;}
KalturaFeedDropFolderFile.inheritsFrom(KalturaDropFolderFile);function KalturaFileAssetListResponse(){this.objects=null;}
KalturaFileAssetListResponse.inheritsFrom(KalturaListResponse);function KalturaFileSyncBaseFilter(){this.partnerIdEqual=null;this.fileObjectTypeEqual=null;this.fileObjectTypeIn=null;this.objectIdEqual=null;this.objectIdIn=null;this.versionEqual=null;this.versionIn=null;this.objectSubTypeEqual=null;this.objectSubTypeIn=null;this.dcEqual=null;this.dcIn=null;this.originalEqual=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;this.readyAtGreaterThanOrEqual=null;this.readyAtLessThanOrEqual=null;this.syncTimeGreaterThanOrEqual=null;this.syncTimeLessThanOrEqual=null;this.statusEqual=null;this.statusIn=null;this.fileTypeEqual=null;this.fileTypeIn=null;this.linkedIdEqual=null;this.linkCountGreaterThanOrEqual=null;this.linkCountLessThanOrEqual=null;this.fileSizeGreaterThanOrEqual=null;this.fileSizeLessThanOrEqual=null;}
...
KalturaFileSyncImportJobData.inheritsFrom(KalturaJobData);function KalturaFileSyncListResponse(){this.objects=null;}
KalturaFileSyncListResponse.inheritsFrom(KalturaListResponse);function KalturaFlattenJobData(){}
KalturaFlattenJobData.inheritsFrom(KalturaJobData);function KalturaFlavorAssetListResponse(){this.objects=null;}
KalturaFlavorAssetListResponse.inheritsFrom(KalturaListResponse);function KalturaFlavorParamsListResponse(){this.objects=null;}
KalturaFlavorParamsListResponse.inheritsFrom(KalturaListResponse);function KalturaFlavorParamsOutputListResponse(){this.objects=null;}
KalturaFlavorParamsOutputListResponse.inheritsFrom(KalturaListResponse);function KalturaGenericDistributionJobProviderData(){this.xml=null;this.resultParseData=null;this.resultParserType=null;}
...
KalturaGenericDistributionProviderActionBaseFilter.inheritsFrom(KalturaFilter);function KalturaGenericDistributionProviderActionListResponse(){this.objects=null;}
KalturaGenericDistributionProviderActionListResponse.inheritsFrom(KalturaListResponse);function KalturaGenericDistributionProviderListResponse(){this.objects=null;}
KalturaGenericDistributionProviderListResponse.inheritsFrom(KalturaListResponse);function KalturaGenericSyndicationFeed(){this.feedDescription=null;this.feedLandingPage=null;}
...
KalturaGoogleVideoSyndicationFeed.inheritsFrom(KalturaBaseSyndicationFeed);function KalturaGroupUserListResponse(){this.objects=null;}
KalturaGroupUserListResponse.inheritsFrom(KalturaListResponse);function KalturaHttpNotificationDataFields(){}
...
KalturaIndexTagsByPrivacyContextJobData.inheritsFrom(KalturaJobData);function KalturaIntegrationJobData(){this.callbackNotificationBaseUrl=null;this.providerType=null;this.providerData=null;this.triggerType=null;this.triggerData=null;}
KalturaIntegrationJobData.inheritsFrom(KalturaJobData);function KalturaIpAddressRestriction(){this.ipAddressRestrictionType=null;this.ipAddressList=null;}
...
KalturaLimitFlavorsRestriction.inheritsFrom(KalturaBaseRestriction);function KalturaLiveChannelListResponse(){this.objects=null;}
KalturaLiveChannelListResponse.inheritsFrom(KalturaListResponse);function KalturaLiveChannelSegmentListResponse(){this.objects=null;}
KalturaLiveChannelSegmentListResponse.inheritsFrom(KalturaListResponse);function KalturaLiveReportExportJobData(){this.timeReference=null;this.timeZoneOffset=null;this.entryIds=null;this.outputPath=null;this.recipientEmail=null;}
KalturaLiveReportExportJobData.inheritsFrom(KalturaJobData);function KalturaLiveStatsListResponse(){this.objects=null;}
KalturaLiveStatsListResponse.inheritsFrom(KalturaListResponse);function KalturaLiveStreamListResponse(){this.objects=null;}
KalturaLiveStreamListResponse.inheritsFrom(KalturaListResponse);function KalturaLiveStreamPushPublishRTMPConfiguration(){this.userId=null;this.password=null;this.streamName=null;this.applicationName=null;}
...
KalturaMediaInfoBaseFilter.inheritsFrom(KalturaFilter);function KalturaMediaInfoListResponse(){this.objects=null;}
KalturaMediaInfoListResponse.inheritsFrom(KalturaListResponse);function KalturaMediaListResponse(){this.objects=null;}
KalturaMediaListResponse.inheritsFrom(KalturaListResponse);function KalturaMediaServerBaseFilter(){this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;}
KalturaMediaServerBaseFilter.inheritsFrom(KalturaFilter);function KalturaMetadataListResponse(){this.objects=null;}
KalturaMetadataListResponse.inheritsFrom(KalturaListResponse);function KalturaMetadataProfileBaseFilter(){this.idEqual=null;this.partnerIdEqual=null;this.metadataObjectTypeEqual=null;this.metadataObjectTypeIn=null;this.versionEqual=null;this.nameEqual=null;this.systemNameEqual=null;this.systemNameIn=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;this.statusEqual=null;this.statusIn=null;this.createModeEqual=null;this.createModeNotEqual=null;this.createModeIn=null;this.createModeNotIn=null;}
KalturaMetadataProfileBaseFilter.inheritsFrom(KalturaFilter);function KalturaMetadataProfileFieldListResponse(){this.objects=null;}
KalturaMetadataProfileFieldListResponse.inheritsFrom(KalturaListResponse);function KalturaMetadataProfileListResponse(){this.objects=null;}
KalturaMetadataProfileListResponse.inheritsFrom(KalturaListResponse);function KalturaMetadataResponseProfileMapping(){}
KalturaMetadataResponseProfileMapping.inheritsFrom(KalturaResponseProfileMapping);function KalturaMixListResponse(){this.objects=null;}
KalturaMixListResponse.inheritsFrom(KalturaListResponse);function KalturaModerationFlagListResponse(){this.objects=null;}
KalturaModerationFlagListResponse.inheritsFrom(KalturaListResponse);function KalturaModifyCategoriesObjectTask(){this.addRemoveType=null;this.categoryIds=null;}
...
KalturaNotificationJobData.inheritsFrom(KalturaJobData);function KalturaObjectListResponse(){this.objects=null;}
KalturaObjectListResponse.inheritsFrom(KalturaListResponse);function KalturaOrCondition(){this.conditions=null;}
KalturaOrCondition.inheritsFrom(KalturaCondition);function KalturaParseCaptionAssetJobData(){this.captionAssetId=null;}
...
KalturaPartnerBaseFilter.inheritsFrom(KalturaFilter);function KalturaPartnerListResponse(){this.objects=null;}
KalturaPartnerListResponse.inheritsFrom(KalturaListResponse);function KalturaPartnerUsageListResponse(){this.total=null;this.objects=null;}
KalturaPartnerUsageListResponse.inheritsFrom(KalturaListResponse);function KalturaPermissionItemListResponse(){this.objects=null;}
KalturaPermissionItemListResponse.inheritsFrom(KalturaListResponse);function KalturaPermissionListResponse(){this.objects=null;}
KalturaPermissionListResponse.inheritsFrom(KalturaListResponse);function KalturaPlayReadyCopyRight(){this.copyCount=null;this.copyEnablers=null;}
...
KalturaPlayReadyProfile.inheritsFrom(KalturaDrmProfile);function KalturaPlaylistListResponse(){this.objects=null;}
KalturaPlaylistListResponse.inheritsFrom(KalturaListResponse);function KalturaProvisionJobData(){this.streamID=null;this.backupStreamID=null;this.rtmp=null;this.encoderIP=null;this.backupEncoderIP=null;this.encoderPassword=null;this.encoderUsername=null;this.endDate=null;this.returnVal=null;this.mediaType=null;this.primaryBroadcastingUrl=null;this.secondaryBroadcastingUrl=null;this.streamName=null;}
KalturaProvisionJobData.inheritsFrom(KalturaJobData);function KalturaRemoteDropFolder(){}
KalturaRemoteDropFolder.inheritsFrom(KalturaDropFolder);function KalturaRemotePathListResponse(){this.objects=null;}
KalturaRemotePathListResponse.inheritsFrom(KalturaListResponse);function KalturaReportBaseFilter(){this.idEqual=null;this.idIn=null;this.partnerIdEqual=null;this.partnerIdIn=null;this.systemNameEqual=null;this.systemNameIn=null;}
...
KalturaReportInputFilter.inheritsFrom(KalturaReportInputBaseFilter);function KalturaReportListResponse(){this.objects=null;}
KalturaReportListResponse.inheritsFrom(KalturaListResponse);function KalturaResponseProfileBaseFilter(){this.idEqual=null;this.idIn=null;this.systemNameEqual=null;this.systemNameIn=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;this.statusEqual=null;this.statusIn=null;}
KalturaResponseProfileBaseFilter.inheritsFrom(KalturaFilter);function KalturaResponseProfileHolder(){this.id=null;this.systemName=null;}
KalturaResponseProfileHolder.inheritsFrom(KalturaBaseResponseProfile);function KalturaResponseProfileListResponse(){this.objects=null;}
KalturaResponseProfileListResponse.inheritsFrom(KalturaListResponse);function KalturaScheduledTaskJobData(){this.maxResults=null;this.resultsFilePath=null;this.referenceTime=null;}
...
KalturaScheduledTaskProfileBaseFilter.inheritsFrom(KalturaFilter);function KalturaScheduledTaskProfileListResponse(){this.objects=null;}
KalturaScheduledTaskProfileListResponse.inheritsFrom(KalturaListResponse);function KalturaSchedulerListResponse(){this.objects=null;}
KalturaSchedulerListResponse.inheritsFrom(KalturaListResponse);function KalturaSchedulerWorkerListResponse(){this.objects=null;}
KalturaSchedulerWorkerListResponse.inheritsFrom(KalturaListResponse);function KalturaSearchCondition(){this.field=null;this.value=null;}
...
KalturaShortLinkBaseFilter.inheritsFrom(KalturaFilter);function KalturaShortLinkListResponse(){this.objects=null;}
KalturaShortLinkListResponse.inheritsFrom(KalturaListResponse);function KalturaSiteRestriction(){this.siteRestrictionType=null;this.siteList=null;}
KalturaSiteRestriction.inheritsFrom(KalturaBaseRestriction);function KalturaStorageAddAction(){}
KalturaStorageAddAction.inheritsFrom(KalturaRuleAction);function KalturaStorageExportObjectTask(){this.storageId=null;}
KalturaStorageExportObjectTask.inheritsFrom(KalturaObjectTask);function KalturaStorageJobData(){this.serverUrl=null;this.serverUsername=null;this.serverPassword=null;this.serverPrivateKey=null;this.serverPublicKey=null;this.serverPassPhrase=null;this.ftpPassiveMode=null;this.srcFileSyncLocalPath=null;this.srcFileSyncId=null;this.destFileSyncStoredPath=null;}
...
KalturaStorageProfileBaseFilter.inheritsFrom(KalturaFilter);function KalturaStorageProfileListResponse(){this.objects=null;}
KalturaStorageProfileListResponse.inheritsFrom(KalturaListResponse);function KalturaSyncCategoryPrivacyContextJobData(){this.categoryId=null;this.lastUpdatedCategoryEntryCreatedAt=null;this.lastUpdatedCategoryCreatedAt=null;}
...
KalturaTagFilter.inheritsFrom(KalturaFilter);function KalturaTagListResponse(){this.objects=null;}
KalturaTagListResponse.inheritsFrom(KalturaListResponse);function KalturaThumbAssetListResponse(){this.objects=null;}
KalturaThumbAssetListResponse.inheritsFrom(KalturaListResponse);function KalturaThumbCuePoint(){this.assetId=null;this.description=null;this.title=null;this.subType=null;}
KalturaThumbCuePoint.inheritsFrom(KalturaCuePoint);function KalturaThumbParamsListResponse(){this.objects=null;}
KalturaThumbParamsListResponse.inheritsFrom(KalturaListResponse);function KalturaThumbParamsOutputListResponse(){this.objects=null;}
KalturaThumbParamsOutputListResponse.inheritsFrom(KalturaListResponse);function KalturaTransformMetadataJobData(){this.srcXslPath=null;this.srcVersion=null;this.destVersion=null;this.destXsdPath=null;this.metadataProfileId=null;}
...
KalturaUiConfBaseFilter.inheritsFrom(KalturaFilter);function KalturaUiConfListResponse(){this.objects=null;}
KalturaUiConfListResponse.inheritsFrom(KalturaListResponse);function KalturaUploadTokenBaseFilter(){this.idEqual=null;this.idIn=null;this.userIdEqual=null;this.statusEqual=null;this.statusIn=null;this.fileNameEqual=null;this.fileSizeEqual=null;}
KalturaUploadTokenBaseFilter.inheritsFrom(KalturaFilter);function KalturaUploadTokenListResponse(){this.objects=null;}
KalturaUploadTokenListResponse.inheritsFrom(KalturaListResponse);function KalturaUrlRecognizerAkamaiG2O(){this.headerData=null;this.headerSign=null;this.timeout=null;this.salt=null;}
...
KalturaUrlTokenizerBitGravity.inheritsFrom(KalturaUrlTokenizer);function KalturaUrlTokenizerCloudFront(){this.keyPairId=null;this.rootDir=null;}
KalturaUrlTokenizerCloudFront.inheritsFrom(KalturaUrlTokenizer);function KalturaUrlTokenizerLevel3(){this.paramName=null;this.expiryName=null;this.gen=null;}
...
KalturaUserAgentRestriction.inheritsFrom(KalturaBaseRestriction);function KalturaUserListResponse(){this.objects=null;}
KalturaUserListResponse.inheritsFrom(KalturaListResponse);function KalturaUserLoginDataListResponse(){this.objects=null;}
KalturaUserLoginDataListResponse.inheritsFrom(KalturaListResponse);function KalturaUserRoleCondition(){this.roleIds=null;}
KalturaUserRoleCondition.inheritsFrom(KalturaCondition);function KalturaUserRoleListResponse(){this.objects=null;}
KalturaUserRoleListResponse.inheritsFrom(KalturaListResponse);function KalturaVarPartnerUsageTotalItem(){}
...
KalturaVirusScanProfileBaseFilter.inheritsFrom(KalturaFilter);function KalturaVirusScanProfileListResponse(){this.objects=null;}
KalturaVirusScanProfileListResponse.inheritsFrom(KalturaListResponse);function KalturaWebexDropFolder(){this.webexUserId=null;this.webexPassword=null;this.webexSiteId=null;this.webexPartnerId=null;this.webexServiceUrl=null;this.webexHostIdMetadataFieldName=null;}
...
KalturaWidgetBaseFilter.inheritsFrom(KalturaFilter);function KalturaWidgetListResponse(){this.objects=null;}
KalturaWidgetListResponse.inheritsFrom(KalturaListResponse);function KalturaYahooSyndicationFeed(){this.category=null;this.adultContent=null;this.feedDescription=null;this.feedLandingPage=null;}
KalturaYahooSyndicationFeed.inheritsFrom(KalturaBaseSyndicationFeed);function KalturaAccessControlBaseFilter(){this.idEqual=null;this.idIn=null;this.systemNameEqual=null;this.systemNameIn=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;}
KalturaAccessControlBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaAccessControlProfileBaseFilter(){this.idEqual=null;this.idIn=null;this.systemNameEqual=null;this.systemNameIn=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;}
KalturaAccessControlProfileBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaAkamaiProvisionJobData(){this.wsdlUsername=null;this.wsdlPassword=null;this.cpcode=null;this.emailId=null;this.primaryContact=null;this.secondaryContact=null;}
...
KalturaAkamaiUniversalProvisionJobData.inheritsFrom(KalturaProvisionJobData);function KalturaAssetBaseFilter(){this.idEqual=null;this.idIn=null;this.entryIdEqual=null;this.entryIdIn=null;this.partnerIdEqual=null;this.partnerIdIn=null;this.sizeGreaterThanOrEqual=null;this.sizeLessThanOrEqual=null;this.tagsLike=null;this.tagsMultiLikeOr=null;this.tagsMultiLikeAnd=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;this.deletedAtGreaterThanOrEqual=null;this.deletedAtLessThanOrEqual=null;}
KalturaAssetBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaAssetParamsBaseFilter(){this.systemNameEqual=null;this.systemNameIn=null;this.isSystemDefaultEqual=null;this.tagsEqual=null;}
KalturaAssetParamsBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaAssetResource(){this.assetId=null;}
KalturaAssetResource.inheritsFrom(KalturaContentResource);function KalturaAuditTrailBaseFilter(){this.idEqual=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.parsedAtGreaterThanOrEqual=null;this.parsedAtLessThanOrEqual=null;this.statusEqual=null;this.statusIn=null;this.auditObjectTypeEqual=null;this.auditObjectTypeIn=null;this.objectIdEqual=null;this.objectIdIn=null;this.relatedObjectIdEqual=null;this.relatedObjectIdIn=null;this.relatedObjectTypeEqual=null;this.relatedObjectTypeIn=null;this.entryIdEqual=null;this.entryIdIn=null;this.masterPartnerIdEqual=null;this.masterPartnerIdIn=null;this.partnerIdEqual=null;this.partnerIdIn=null;this.requestIdEqual=null;this.requestIdIn=null;this.userIdEqual=null;this.userIdIn=null;this.actionEqual=null;this.actionIn=null;this.ksEqual=null;this.contextEqual=null;this.contextIn=null;this.entryPointEqual=null;this.entryPointIn=null;this.serverNameEqual=null;this.serverNameIn=null;this.ipAddressEqual=null;this.ipAddressIn=null;this.clientTagEqual=null;}
KalturaAuditTrailBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaBaseSyndicationFeedFilter(){}
...
KalturaBulkUploadXmlJobData.inheritsFrom(KalturaBulkUploadJobData);function KalturaBusinessProcessAbortNotificationTemplate(){}
KalturaBusinessProcessAbortNotificationTemplate.inheritsFrom(KalturaBusinessProcessNotificationTemplate);function KalturaBusinessProcessNotificationDispatchJobData(){this.server=null;this.caseId=null;}
KalturaBusinessProcessNotificationDispatchJobData.inheritsFrom(KalturaEventNotificationDispatchJobData);function KalturaBusinessProcessServerFilter(){}
KalturaBusinessProcessServerFilter.inheritsFrom(KalturaBusinessProcessServerBaseFilter);function KalturaBusinessProcessSignalNotificationTemplate(){this.message=null;this.eventId=null;}
KalturaBusinessProcessSignalNotificationTemplate.inheritsFrom(KalturaBusinessProcessNotificationTemplate);function KalturaBusinessProcessStartNotificationTemplate(){this.abortOnDeletion=null;}
KalturaBusinessProcessStartNotificationTemplate.inheritsFrom(KalturaBusinessProcessNotificationTemplate);function KalturaCategoryBaseFilter(){this.idEqual=null;this.idIn=null;this.parentIdEqual=null;this.parentIdIn=null;this.depthEqual=null;this.fullNameEqual=null;this.fullNameStartsWith=null;this.fullNameIn=null;this.fullIdsEqual=null;this.fullIdsStartsWith=null;this.fullIdsMatchOr=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;this.tagsLike=null;this.tagsMultiLikeOr=null;this.tagsMultiLikeAnd=null;this.appearInListEqual=null;this.privacyEqual=null;this.privacyIn=null;this.inheritanceTypeEqual=null;this.inheritanceTypeIn=null;this.referenceIdEqual=null;this.referenceIdEmpty=null;this.contributionPolicyEqual=null;this.membersCountGreaterThanOrEqual=null;this.membersCountLessThanOrEqual=null;this.pendingMembersCountGreaterThanOrEqual=null;this.pendingMembersCountLessThanOrEqual=null;this.privacyContextEqual=null;this.statusEqual=null;this.statusIn=null;this.inheritedParentIdEqual=null;this.inheritedParentIdIn=null;this.partnerSortValueGreaterThanOrEqual=null;this.partnerSortValueLessThanOrEqual=null;}
KalturaCategoryBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaCategoryEntryBaseFilter(){this.categoryIdEqual=null;this.categoryIdIn=null;this.entryIdEqual=null;this.entryIdIn=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.categoryFullIdsStartsWith=null;this.statusEqual=null;this.statusIn=null;}
KalturaCategoryEntryBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaCompareMetadataCondition(){this.xPath=null;this.profileId=null;this.profileSystemName=null;}
KalturaCompareMetadataCondition.inheritsFrom(KalturaCompareCondition);function KalturaControlPanelCommandFilter(){}
KalturaControlPanelCommandFilter.inheritsFrom(KalturaControlPanelCommandBaseFilter);function KalturaConversionProfileAssetParamsBaseFilter(){this.conversionProfileIdEqual=null;this.conversionProfileIdIn=null;this.assetParamsIdEqual=null;this.assetParamsIdIn=null;this.readyBehaviorEqual=null;this.readyBehaviorIn=null;this.originEqual=null;this.originIn=null;this.systemNameEqual=null;this.systemNameIn=null;}
KalturaConversionProfileAssetParamsBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaConversionProfileBaseFilter(){this.idEqual=null;this.idIn=null;this.statusEqual=null;this.statusIn=null;this.typeEqual=null;this.typeIn=null;this.nameEqual=null;this.systemNameEqual=null;this.systemNameIn=null;this.tagsMultiLikeOr=null;this.tagsMultiLikeAnd=null;this.defaultEntryIdEqual=null;this.defaultEntryIdIn=null;}
KalturaConversionProfileBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaConvertCollectionJobData(){this.destDirLocalPath=null;this.destDirRemoteUrl=null;this.destFileName=null;this.inputXmlLocalPath=null;this.inputXmlRemoteUrl=null;this.commandLinesStr=null;this.flavors=null;}
...
KalturaEmailNotificationDispatchJobData.inheritsFrom(KalturaEventNotificationDispatchJobData);function KalturaEndUserReportInputFilter(){this.application=null;this.userIds=null;this.playbackContext=null;this.ancestorPlaybackContext=null;}
KalturaEndUserReportInputFilter.inheritsFrom(KalturaReportInputFilter);function KalturaEntryDistributionBaseFilter(){this.idEqual=null;this.idIn=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;this.submittedAtGreaterThanOrEqual=null;this.submittedAtLessThanOrEqual=null;this.entryIdEqual=null;this.entryIdIn=null;this.distributionProfileIdEqual=null;this.distributionProfileIdIn=null;this.statusEqual=null;this.statusIn=null;this.dirtyStatusEqual=null;this.dirtyStatusIn=null;this.sunriseGreaterThanOrEqual=null;this.sunriseLessThanOrEqual=null;this.sunsetGreaterThanOrEqual=null;this.sunsetLessThanOrEqual=null;}
KalturaEntryDistributionBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaEntryReferrerLiveStats(){this.referrer=null;}
...
KalturaFieldMatchCondition.inheritsFrom(KalturaMatchCondition);function KalturaFileAssetBaseFilter(){this.idEqual=null;this.idIn=null;this.partnerIdEqual=null;this.fileAssetObjectTypeEqual=null;this.objectIdEqual=null;this.objectIdIn=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;this.statusEqual=null;this.statusIn=null;}
KalturaFileAssetBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaFileSyncFilter(){this.currentDc=null;}
...
KalturaGeoTimeLiveStats.inheritsFrom(KalturaEntryLiveStats);function KalturaGroupUserBaseFilter(){this.userIdEqual=null;this.userIdIn=null;this.groupIdEqual=null;this.groupIdIn=null;this.statusEqual=null;this.statusIn=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;}
KalturaGroupUserBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaHttpNotificationDispatchJobData(){this.url=null;this.method=null;this.data=null;this.timeout=null;this.connectTimeout=null;this.username=null;this.password=null;this.authenticationMethod=null;this.sslVersion=null;this.sslCertificate=null;this.sslCertificateType=null;this.sslCertificatePassword=null;this.sslEngine=null;this.sslEngineDefault=null;this.sslKeyType=null;this.sslKey=null;this.sslKeyPassword=null;this.customHeaders=null;this.signSecret=null;}
...
KalturaLiveChannelSegmentBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaLiveParams(){this.streamSuffix=null;}
...
KalturaMediaInfoFilter.inheritsFrom(KalturaMediaInfoBaseFilter);function KalturaMetadataBaseFilter(){this.partnerIdEqual=null;this.metadataProfileIdEqual=null;this.metadataProfileVersionEqual=null;this.metadataProfileVersionGreaterThanOrEqual=null;this.metadataProfileVersionLessThanOrEqual=null;this.metadataObjectTypeEqual=null;this.objectIdEqual=null;this.objectIdIn=null;this.versionEqual=null;this.versionGreaterThanOrEqual=null;this.versionLessThanOrEqual=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;this.statusEqual=null;this.statusIn=null;}
KalturaMetadataBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaMetadataFieldChangedCondition(){this.xPath=null;this.profileId=null;this.profileSystemName=null;this.versionA=null;this.versionB=null;}
KalturaMetadataFieldChangedCondition.inheritsFrom(KalturaMatchCondition);function KalturaMetadataProfileFilter(){}
...
KalturaPdfFlavorParams.inheritsFrom(KalturaFlavorParams);function KalturaPermissionBaseFilter(){this.idEqual=null;this.idIn=null;this.typeEqual=null;this.typeIn=null;this.nameEqual=null;this.nameIn=null;this.friendlyNameLike=null;this.descriptionLike=null;this.statusEqual=null;this.statusIn=null;this.partnerIdEqual=null;this.partnerIdIn=null;this.dependsOnPermissionNamesMultiLikeOr=null;this.dependsOnPermissionNamesMultiLikeAnd=null;this.tagsMultiLikeOr=null;this.tagsMultiLikeAnd=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;}
KalturaPermissionBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaPermissionItemBaseFilter(){this.idEqual=null;this.idIn=null;this.typeEqual=null;this.typeIn=null;this.partnerIdEqual=null;this.partnerIdIn=null;this.tagsMultiLikeOr=null;this.tagsMultiLikeAnd=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;}
KalturaPermissionItemBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaPostConvertJobData(){this.flavorAssetId=null;this.createThumb=null;this.thumbPath=null;this.thumbOffset=null;this.thumbHeight=null;this.thumbBitrate=null;this.customData=null;}
...
KalturaReportFilter.inheritsFrom(KalturaReportBaseFilter);function KalturaResponseProfileFilter(){}
KalturaResponseProfileFilter.inheritsFrom(KalturaResponseProfileBaseFilter);function KalturaScheduledTaskProfileFilter(){}
...
KalturaUploadTokenFilter.inheritsFrom(KalturaUploadTokenBaseFilter);function KalturaUserLoginDataBaseFilter(){this.loginEmailEqual=null;}
KalturaUserLoginDataBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaUserRoleBaseFilter(){this.idEqual=null;this.idIn=null;this.nameEqual=null;this.nameIn=null;this.systemNameEqual=null;this.systemNameIn=null;this.descriptionLike=null;this.statusEqual=null;this.statusIn=null;this.partnerIdEqual=null;this.partnerIdIn=null;this.tagsMultiLikeOr=null;this.tagsMultiLikeAnd=null;this.createdAtGreaterThanOrEqual=null;this.createdAtLessThanOrEqual=null;this.updatedAtGreaterThanOrEqual=null;this.updatedAtLessThanOrEqual=null;}
KalturaUserRoleBaseFilter.inheritsFrom(KalturaRelatedFilter);function KalturaVelocixProvisionJobData(){this.provisioningParams=null;this.userName=null;this.password=null;}
...
KalturaWidgetFilter.inheritsFrom(KalturaWidgetBaseFilter);function KalturaAccessControlFilter(){}
KalturaAccessControlFilter.inheritsFrom(KalturaAccessControlBaseFilter);function KalturaAccessControlProfileFilter(){}
KalturaAccessControlProfileFilter.inheritsFrom(KalturaAccessControlProfileBaseFilter);function KalturaActivitiBusinessProcessServerBaseFilter(){}
KalturaActivitiBusinessProcessServerBaseFilter.inheritsFrom(KalturaBusinessProcessServerFilter);function KalturaAmazonS3StorageExportJobData(){this.filesPermissionInS3=null;this.s3Region=null;}
...
KalturaAmazonS3StorageProfileBaseFilter.inheritsFrom(KalturaStorageProfileFilter);function KalturaAssetFilter(){}
KalturaAssetFilter.inheritsFrom(KalturaAssetBaseFilter);function KalturaAssetParamsFilter(){}
KalturaAssetParamsFilter.inheritsFrom(KalturaAssetParamsBaseFilter);function KalturaAuditTrailFilter(){}
KalturaAuditTrailFilter.inheritsFrom(KalturaAuditTrailBaseFilter);function KalturaBatchJobFilterExt(){this.jobTypeAndSubTypeIn=null;}
KalturaBatchJobFilterExt.inheritsFrom(KalturaBatchJobFilter);function KalturaBusinessProcessNotificationTemplateBaseFilter(){}
KalturaBusinessProcessNotificationTemplateBaseFilter.inheritsFrom(KalturaEventNotificationTemplateFilter);function KalturaCategoryEntryFilter(){}
...
KalturaCategoryFilter.inheritsFrom(KalturaCategoryBaseFilter);function KalturaConfigurableDistributionProfileBaseFilter(){}
KalturaConfigurableDistributionProfileBaseFilter.inheritsFrom(KalturaDistributionProfileFilter);function KalturaConversionProfileFilter(){}
...
KalturaConversionProfileAssetParamsFilter.inheritsFrom(KalturaConversionProfileAssetParamsBaseFilter);function KalturaCoordinatesContextField(){this.geoCoderType=null;}
...
KalturaCountryContextField.inheritsFrom(KalturaStringField);function KalturaCuePointFilter(){this.freeText=null;}
KalturaCuePointFilter.inheritsFrom(KalturaCuePointBaseFilter);function KalturaDeliveryProfileAkamaiAppleHttpManifestBaseFilter(){}
...
KalturaDistributionEnableJobData.inheritsFrom(KalturaDistributionUpdateJobData);function KalturaDocumentFlavorParamsOutput(){}
...
KalturaEmailNotificationTemplateBaseFilter.inheritsFrom(KalturaEventNotificationTemplateFilter);function KalturaEntryDistributionFilter(){}
KalturaEntryDistributionFilter.inheritsFrom(KalturaEntryDistributionBaseFilter);function KalturaEvalBooleanField(){this.code=null;}
KalturaEvalBooleanField.inheritsFrom(KalturaBooleanField);function KalturaEvalStringField(){this.code=null;}
KalturaEvalStringField.inheritsFrom(KalturaStringField);function KalturaFileAssetFilter(){}
KalturaFileAssetFilter.inheritsFrom(KalturaFileAssetBaseFilter);function KalturaGenericDistributionProfileBaseFilter(){}
...
KalturaGoogleVideoSyndicationFeedBaseFilter.inheritsFrom(KalturaBaseSyndicationFeedFilter);function KalturaGroupUserFilter(){}
KalturaGroupUserFilter.inheritsFrom(KalturaGroupUserBaseFilter);function KalturaHttpNotificationTemplateBaseFilter(){}
...
KalturaKontikiStorageProfileBaseFilter.inheritsFrom(KalturaStorageProfileFilter);function KalturaLiveChannelSegmentFilter(){}
KalturaLiveChannelSegmentFilter.inheritsFrom(KalturaLiveChannelSegmentBaseFilter);function KalturaMediaFlavorParamsOutput(){}
KalturaMediaFlavorParamsOutput.inheritsFrom(KalturaFlavorParamsOutput);function KalturaMetadataFilter(){}
KalturaMetadataFilter.inheritsFrom(KalturaMetadataBaseFilter);function KalturaObjectIdField(){}
KalturaObjectIdField.inheritsFrom(KalturaStringField);function KalturaPdfFlavorParamsOutput(){this.readonly=null;}
KalturaPdfFlavorParamsOutput.inheritsFrom(KalturaFlavorParamsOutput);function KalturaPermissionFilter(){}
KalturaPermissionFilter.inheritsFrom(KalturaPermissionBaseFilter);function KalturaPermissionItemFilter(){}
KalturaPermissionItemFilter.inheritsFrom(KalturaPermissionItemBaseFilter);function KalturaPlayReadyPolicyBaseFilter(){}
KalturaPlayReadyPolicyBaseFilter.inheritsFrom(KalturaDrmPolicyFilter);function KalturaPlayReadyProfileBaseFilter(){}
KalturaPlayReadyProfileBaseFilter.inheritsFrom(KalturaDrmProfileFilter);function KalturaRemoteDropFolderBaseFilter(){}
...
KalturaSyndicationDistributionProviderBaseFilter.inheritsFrom(KalturaDistributionProviderFilter);function KalturaTimeContextField(){this.offset=null;}
...
KalturaUserEmailContextField.inheritsFrom(KalturaStringField);function KalturaUserLoginDataFilter(){}
KalturaUserLoginDataFilter.inheritsFrom(KalturaUserLoginDataBaseFilter);function KalturaUserRoleFilter(){}
KalturaUserRoleFilter.inheritsFrom(KalturaUserRoleBaseFilter);function KalturaVarConsolePartnerFilter(){this.groupTypeEq=null;this.groupTypeIn=null;this.partnerPermissionsExist=null;}
...
KalturaAttachmentAssetBaseFilter.inheritsFrom(KalturaAssetFilter);function KalturaBusinessProcessNotificationTemplateFilter(){}
KalturaBusinessProcessNotificationTemplateFilter.inheritsFrom(KalturaBusinessProcessNotificationTemplateBaseFilter);function KalturaCaptionAssetBaseFilter(){this.captionParamsIdEqual=null;this.captionParamsIdIn=null;this.formatEqual=null;this.formatIn=null;this.statusEqual=null;this.statusIn=null;this.statusNotIn=null;}
...
KalturaCodeCuePointBaseFilter.inheritsFrom(KalturaCuePointFilter);function KalturaConfigurableDistributionProfileFilter(){}
KalturaConfigurableDistributionProfileFilter.inheritsFrom(KalturaConfigurableDistributionProfileBaseFilter);function KalturaDataEntryBaseFilter(){}
KalturaDataEntryBaseFilter.inheritsFrom(KalturaBaseEntryFilter);function KalturaDeliveryProfileAkamaiAppleHttpManifestFilter(){}
...
KalturaDeliveryProfileRtmpFilter.inheritsFrom(KalturaDeliveryProfileRtmpBaseFilter);function KalturaDocumentEntryBaseFilter(){this.documentTypeEqual=null;this.documentTypeIn=null;this.assetParamsIdsMatchOr=null;this.assetParamsIdsMatchAnd=null;}
KalturaDocumentEntryBaseFilter.inheritsFrom(KalturaBaseEntryFilter);function KalturaEmailNotificationTemplateFilter(){}
KalturaEmailNotificationTemplateFilter.inheritsFrom(KalturaEmailNotificationTemplateBaseFilter);function KalturaEventCuePointBaseFilter(){this.eventTypeEqual=null;this.eventTypeIn=null;}
...
KalturaFlavorParamsBaseFilter.inheritsFrom(KalturaAssetParamsFilter);function KalturaGenericDistributionProfileFilter(){}
...
KalturaPlayReadyProfileFilter.inheritsFrom(KalturaPlayReadyProfileBaseFilter);function KalturaPlaylistBaseFilter(){}
KalturaPlaylistBaseFilter.inheritsFrom(KalturaBaseEntryFilter);function KalturaRemoteDropFolderFilter(){}
...
KalturaSyndicationDistributionProfileFilter.inheritsFrom(KalturaSyndicationDistributionProfileBaseFilter);function KalturaThumbAssetBaseFilter(){this.thumbParamsIdEqual=null;this.thumbParamsIdIn=null;this.statusEqual=null;this.statusIn=null;this.statusNotIn=null;}
...
KalturaThumbParamsBaseFilter.inheritsFrom(KalturaAssetParamsFilter);function KalturaTubeMogulSyndicationFeedFilter(){}
...
KalturaYahooSyndicationFeedFilter.inheritsFrom(KalturaYahooSyndicationFeedBaseFilter);function KalturaAdCuePointFilter(){}
KalturaAdCuePointFilter.inheritsFrom(KalturaAdCuePointBaseFilter);function KalturaAdminUserFilter(){}
KalturaAdminUserFilter.inheritsFrom(KalturaAdminUserBaseFilter);function KalturaAnnotationFilter(){}
...
KalturaAttachmentAssetFilter.inheritsFrom(KalturaAttachmentAssetBaseFilter);function KalturaBusinessProcessAbortNotificationTemplateBaseFilter(){}
KalturaBusinessProcessAbortNotificationTemplateBaseFilter.inheritsFrom(KalturaBusinessProcessNotificationTemplateFilter);function KalturaBusinessProcessSignalNotificationTemplateBaseFilter(){}
KalturaBusinessProcessSignalNotificationTemplateBaseFilter.inheritsFrom(KalturaBusinessProcessNotificationTemplateFilter);function KalturaBusinessProcessStartNotificationTemplateBaseFilter(){}
KalturaBusinessProcessStartNotificationTemplateBaseFilter.inheritsFrom(KalturaBusinessProcessNotificationTemplateFilter);function KalturaCaptionAssetFilter(){}
...
KalturaCodeCuePointFilter.inheritsFrom(KalturaCodeCuePointBaseFilter);function KalturaDataEntryFilter(){}
KalturaDataEntryFilter.inheritsFrom(KalturaDataEntryBaseFilter);function KalturaDeliveryProfileGenericRtmpBaseFilter(){}
KalturaDeliveryProfileGenericRtmpBaseFilter.inheritsFrom(KalturaDeliveryProfileRtmpFilter);function KalturaDocumentEntryFilter(){}
KalturaDocumentEntryFilter.inheritsFrom(KalturaDocumentEntryBaseFilter);function KalturaEventCuePointFilter(){}
...
KalturaFlavorParamsFilter.inheritsFrom(KalturaFlavorParamsBaseFilter);function KalturaFtpDropFolderBaseFilter(){}
...
KalturaGenericXsltSyndicationFeedBaseFilter.inheritsFrom(KalturaGenericSyndicationFeedFilter);function KalturaLiveStreamAdminEntry(){}
KalturaLiveStreamAdminEntry.inheritsFrom(KalturaLiveStreamEntry);function KalturaPlaylistFilter(){}
KalturaPlaylistFilter.inheritsFrom(KalturaPlaylistBaseFilter);function KalturaSshDropFolderBaseFilter(){}
KalturaSshDropFolderBaseFilter.inheritsFrom(KalturaRemoteDropFolderFilter);function KalturaThumbAssetFilter(){this.typeIn=null;}
...
KalturaThumbParamsFilter.inheritsFrom(KalturaThumbParamsBaseFilter);function KalturaBusinessProcessAbortNotificationTemplateFilter(){}
KalturaBusinessProcessAbortNotificationTemplateFilter.inheritsFrom(KalturaBusinessProcessAbortNotificationTemplateBaseFilter);function KalturaBusinessProcessSignalNotificationTemplateFilter(){}
KalturaBusinessProcessSignalNotificationTemplateFilter.inheritsFrom(KalturaBusinessProcessSignalNotificationTemplateBaseFilter);function KalturaBusinessProcessStartNotificationTemplateFilter(){}
KalturaBusinessProcessStartNotificationTemplateFilter.inheritsFrom(KalturaBusinessProcessStartNotificationTemplateBaseFilter);function KalturaCaptionAssetItemFilter(){this.contentLike=null;this.contentMultiLikeOr=null;this.contentMultiLikeAnd=null;this.partnerDescriptionLike=null;this.partnerDescriptionMultiLikeOr=null;this.partnerDescriptionMultiLikeAnd=null;this.languageEqual=null;this.languageIn=null;this.labelEqual=null;this.labelIn=null;this.startTimeGreaterThanOrEqual=null;this.startTimeLessThanOrEqual=null;this.endTimeGreaterThanOrEqual=null;this.endTimeLessThanOrEqual=null;}
KalturaCaptionAssetItemFilter.inheritsFrom(KalturaCaptionAssetFilter);function KalturaDeliveryProfileGenericRtmpFilter(){}
KalturaDeliveryProfileGenericRtmpFilter.inheritsFrom(KalturaDeliveryProfileGenericRtmpBaseFilter);function KalturaDocumentFlavorParamsBaseFilter(){}
...
KalturaFlavorParamsOutputBaseFilter.inheritsFrom(KalturaFlavorParamsFilter);function KalturaFtpDropFolderFilter(){}
KalturaFtpDropFolderFilter.inheritsFrom(KalturaFtpDropFolderBaseFilter);function KalturaGenericXsltSyndicationFeedFilter(){}
KalturaGenericXsltSyndicationFeedFilter.inheritsFrom(KalturaGenericXsltSyndicationFeedBaseFilter);function KalturaImageFlavorParamsBaseFilter(){}
...
KalturaLiveParamsBaseFilter.inheritsFrom(KalturaFlavorParamsFilter);function KalturaMediaFlavorParamsBaseFilter(){}
...
KalturaPdfFlavorParamsBaseFilter.inheritsFrom(KalturaFlavorParamsFilter);function KalturaSshDropFolderFilter(){}
KalturaSshDropFolderFilter.inheritsFrom(KalturaSshDropFolderBaseFilter);function KalturaSwfFlavorParamsBaseFilter(){}
...
KalturaWidevineFlavorParamsBaseFilter.inheritsFrom(KalturaFlavorParamsFilter);function KalturaDocumentFlavorParamsFilter(){}
...
KalturaFlavorParamsOutputFilter.inheritsFrom(KalturaFlavorParamsOutputBaseFilter);function KalturaImageFlavorParamsFilter(){}
...
KalturaPdfFlavorParamsFilter.inheritsFrom(KalturaPdfFlavorParamsBaseFilter);function KalturaScpDropFolderBaseFilter(){}
KalturaScpDropFolderBaseFilter.inheritsFrom(KalturaSshDropFolderFilter);function KalturaSftpDropFolderBaseFilter(){}
KalturaSftpDropFolderBaseFilter.inheritsFrom(KalturaSshDropFolderFilter);function KalturaSwfFlavorParamsFilter(){}
...
KalturaPdfFlavorParamsOutputBaseFilter.inheritsFrom(KalturaFlavorParamsOutputFilter);function KalturaScpDropFolderFilter(){}
KalturaScpDropFolderFilter.inheritsFrom(KalturaScpDropFolderBaseFilter);function KalturaSftpDropFolderFilter(){}
KalturaSftpDropFolderFilter.inheritsFrom(KalturaSftpDropFolderBaseFilter);function KalturaSwfFlavorParamsOutputBaseFilter(){}
...
KalturaPdfFlavorParamsOutputFilter.inheritsFrom(KalturaPdfFlavorParamsOutputBaseFilter);function KalturaSwfFlavorParamsOutputFilter(){}
...
this.client.doQueue(callback);}
KalturaFlavorAssetService.prototype.getUrl=function(callback,id,storageId,forceProxy,options){if(!storageId)
storageId=null;if(!forceProxy)
forceProxy=false;if(!options)
options=null;var kparams=new Object();this.client.addParam(kparams,"id",id);this.client.addParam(kparams,"storageId",storageId);this.client.addParam(kparams,"forceProxy",forceProxy);if(options!=null)
this.client.addParam(kparams,"options",toParams(options));this.client.queueServiceActionCall("flavorasset","getUrl",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
...
this.client.doQueue(callback);}
function KalturaGroupUserService(client){this.init(client);}
KalturaGroupUserService.inheritsFrom(KalturaServiceBase);KalturaGroupUserService.prototype.add=function(callback,groupUser){var kparams=new Object();this.client.addParam(kparams,"groupUser",toParams(groupUser));this.client.queueServiceActionCall("groupuser","add",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
KalturaGroupUserService.prototype.deleteAction=function(callback,userId,groupId){var kparams=new Object();this.client.addParam(kparams,"userId",userId);this.client.addParam(kparams,"groupId",groupId);this.client.queueServiceActionCall("groupuser","delete",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
KalturaGroupUserService.prototype.listAction=function(callback,filter,pager){if(!filter)
filter=null;if(!pager)
pager=null;var kparams=new Object();if(filter!=null)
this.client.addParam(kparams,"filter",toParams(filter));if(pager!=null)
this.client.addParam(kparams,"pager",toParams(pager));this.client.queueServiceActionCall("groupuser","list",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
...
this.client.doQueue(callback);}
function KalturaLiveStatsService(client){this.init(client);}
KalturaLiveStatsService.inheritsFrom(KalturaServiceBase);KalturaLiveStatsService.prototype.collect=function(callback,event){var kparams=new Object();this.client.addParam(kparams,"event",toParams(event));this.client.queueServiceActionCall("livestats","collect",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
...
this.client.doQueue(callback);}
KalturaPlaylistService.prototype.execute=function(callback,id,detailed,playlistContext,filter,pager){if(!detailed)
detailed="";if(!playlistContext)
playlistContext=null;if(!filter)
filter=null;if(!pager)
pager=null;var kparams=new Object();this.client.addParam(kparams,"id",id);this.client.addParam(kparams,"detailed",detailed);if(playlistContext!=null)
this.client.addParam(kparams,"playlistContext",toParams(playlistContext));if(filter!=null)
this.client.addParam(kparams,"filter",toParams(filter));if(pager!=null)
this.client.addParam(kparams,"pager",toParams(pager));this.client.queueServiceActionCall("playlist","execute",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
KalturaPlaylistService.prototype.executeFromContent=function(callback,playlistType,playlistContent,detailed,pager){if(!detailed)
detailed="";if(!pager)
pager=null;var kparams=new Object();this.client.addParam(kparams,"playlistType",playlistType);this.client.addParam(kparams,"playlistContent",playlistContent);this.client.addParam(kparams,"detailed",detailed);if(pager!=null)
this.client.addParam(kparams,"pager",toParams(pager));this.client.queueServiceActionCall("playlist","executeFromContent",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
KalturaPlaylistService.prototype.executeFromFilters=function(callback,filters,totalResults,detailed,pager){if(!detailed)
detailed=1;if(!pager)
pager=null;var kparams=new Object();for(var index in filters)
{var obj=filters[index];this.client.addParam(kparams,"filters:"+index,toParams(obj));}
this.client.addParam(kparams,"totalResults",totalResults);this.client.addParam(kparams,"detailed",detailed);if(pager!=null)
this.client.addParam(kparams,"pager",toParams(pager));this.client.queueServiceActionCall("playlist","executeFromFilters",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
...
this.client.doQueue(callback);}
function KalturaResponseProfileService(client){this.init(client);}
KalturaResponseProfileService.inheritsFrom(KalturaServiceBase);KalturaResponseProfileService.prototype.add=function(callback,addResponseProfile){var kparams=new Object();this.client.addParam(kparams,"addResponseProfile",toParams(addResponseProfile));this.client.queueServiceActionCall("responseprofile","add",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
KalturaResponseProfileService.prototype.get=function(callback,id){var kparams=new Object();this.client.addParam(kparams,"id",id);this.client.queueServiceActionCall("responseprofile","get",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
KalturaResponseProfileService.prototype.update=function(callback,id,updateResponseProfile){var kparams=new Object();this.client.addParam(kparams,"id",id);this.client.addParam(kparams,"updateResponseProfile",toParams(updateResponseProfile));this.client.queueServiceActionCall("responseprofile","update",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
KalturaResponseProfileService.prototype.updateStatus=function(callback,id,status){var kparams=new Object();this.client.addParam(kparams,"id",id);this.client.addParam(kparams,"status",status);this.client.queueServiceActionCall("responseprofile","updateStatus",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
KalturaResponseProfileService.prototype.deleteAction=function(callback,id){var kparams=new Object();this.client.addParam(kparams,"id",id);this.client.queueServiceActionCall("responseprofile","delete",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
KalturaResponseProfileService.prototype.listAction=function(callback,filter,pager){if(!filter)
filter=null;if(!pager)
pager=null;var kparams=new Object();if(filter!=null)
this.client.addParam(kparams,"filter",toParams(filter));if(pager!=null)
this.client.addParam(kparams,"pager",toParams(pager));this.client.queueServiceActionCall("responseprofile","list",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
...
this.client.doQueue(callback);}
KalturaMetadataService.prototype.index=function(callback,id,shouldUpdate){var kparams=new Object();this.client.addParam(kparams,"id",id);this.client.addParam(kparams,"shouldUpdate",shouldUpdate);this.client.queueServiceActionCall("metadata_metadata","index",kparams);if(!this.client.isMultiRequest())
this.client.doQueue(callback);}
